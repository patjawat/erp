...
class m260214_174016_create_inventory_v2_tables_table extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%stock_item}}', [
            ...
            'category_id' => $this->string(255)->notNull()->comment('ID หมวดหมู่'),
        ...
        $this->createTable('{{%stock_order}}', [
            ...
            'source_type' => $this->string(50)->comment('เช่น PO, REQUEST, ADJUST'),
        ...
        $this->createTable('{{%stock_detail}}', [
            ...
            'item_code' => $this->string(50)->notNull()->comment('เชื่อมด้วยรหัสพัสดุ'),
            'qty' => $this->decimal(10, 2)->notNull(),
            'remain_qty' => $this->decimal(15, 2)->notNull()->defaultValue(0),
            'unit_price' => $this->decimal(15, 2),
        ...
        $this->createTable('{{%stock_balance}}', [
            ...
            'lot_number' => $this->string(100)->notNull(),
            'balance_qty' => $this->decimal(10, 2)->defaultValue(0),
            'ref' => $this->string(255),
            'data_json' => $this->json(),
            'created_at' => $this->integer(),
            'created_by' => $this->integer(),
