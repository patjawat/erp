...
class ApproveSearch extends Approve
{
    ...
    public function rules()
    {
        return [
            ...
            [['from_id', 'name', 'title', 'data_json', 'status', 'comment', 'created_at', 'updated_at', 'deleted_at','q','leave_type_id','date_start','date_end','q_department','thai_year','date_filter','q_status'], 'safe'],
        ];
    }
