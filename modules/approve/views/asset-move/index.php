                    ...
                    <tr>
                        ...
                        <td class="text-center py-2">
                            <div class="d-flex justify-content-center">
                                <a href="<?= Url::to(['update', 'id' => $item->id, 'title' => '<i class="fa-regular fa-pen-to-square"></i> แก้ไข']) ?>" class="btn btn-icon btn-outline-primary rounded-pill open-modal" data-size="modal-xl" title="ดูรายละเอียด">
