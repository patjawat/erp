...
use app\modules\helpdesk3\models\HelpdeskSearch;
...
class MedicalController extends \yii\web\Controller
{
    public function actionIndex()
    {
        ...
        return $this->render('@app/modules/helpdesk3/views/service/list', [
            'active' => 'index',
    ...
    public function actionDashboard()
    {
        ...
        return $this->render('@app/modules/helpdesk3/views/service/dashboard', [
            'active' => 'dashboard',
            'title' => 'ศูนย์เครื่องมือแพทย์',
            'icon' => '<i class="fa-solid fa-briefcase-medical fs-2"></i>',
            'searchModel' => $searchModel,
    ...
    public function actionAsset()
    {
        ...
        return $this->render('@app/modules/helpdesk3/views/service/list_asset', [
            'active' => 'asset',
            'title' => 'ศูนย์เครื่องมือแพทย์',
            'icon' => '<i class="fa-solid fa-briefcase-medical fs-2"></i>',
