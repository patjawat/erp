...
use yii\web\View;
use yii\helpers\Url;
use app\modules\helpdesk3\models\Helpdesk;

$total = Helpdesk::find()->where(['in','status',['pending','receive','in_progress','success']])
->andFilterWhere(['repair_group' => $model->repair_group])
->andFilterWhere(['thai_year' => $model->thai_year])
->count();
$status2 = Helpdesk::find()->where(['in','status',['pending','receive','in_progress']])
->andFilterWhere(['repair_group' => $model->repair_group])
->andFilterWhere(['thai_year' => $model->thai_year])
->count();
$status4 = Helpdesk::find()->where(['status' => 'success'])
->andFilterWhere(['repair_group' => $model->repair_group])
->andFilterWhere(['thai_year' => $model->thai_year])
->count();
try {
