...
<?php echo $this->render('@app/modules/helpdesk3/menu',['active' => 'asset']) ?>
<?php $this->endBlock(); ?>
...
<div class="card">
    ...
    <div class="card-body">
        <?=$this->render('@app/modules/helpdesk3/views/service/_search_asset', ['model' => $searchModel,'listAssetType'=> $listAssetType])?>
    </div>
</div>
