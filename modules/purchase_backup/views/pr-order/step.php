...
<?php if ($model->status == $status->code): ?>
    <div class="step step-warning">
        <div>
            <div class="circle"><i class="fa-solid fa-triangle-exclamation"></i></div>
        </div>
        <div>
...
<?php if ($status->code < $model->status): ?>
    <div class="step step-active">
        ...
        <div>
            <div class="title"><?= $status->title ?></div>
            <div class="caption"><?= $model->code ?></div>
        </div>
    </div>
<?php else: ?>
        <div class="step">
...
<?php if ($status->code < $model->status): ?>
    <div class="step step-active">
        ...
        <div>
            <div class="title"><?= $status->title ?>xx</div>
            <div class="caption"><?= $model->code ?></div>
        </div>
    </div>
