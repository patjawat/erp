    ...
    <div class="d-flex flex-wrap align-items-center gap-2 justify-content-lg-end">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li><a class="dropdown-item <?= $active === 'report-monthly-snapshot' ? 'active' : '' ?>" href="<?= Url::to(['/inventory-v2/monthly-snapshot/index']) ?>"><i class="bi bi-file-earmark-check me-2"></i>ตรวจไฟล์ยอดปิดเดือน</a></li>
