        ...
        <div class="col-12 col-lg-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-primary bg-opacity-10 border-0 py-2 px-3">
                    ...
                    <span class="text-muted small d-block mt-1">รับของเข้าคลัง จ่ายของออกตามใบขอเบิกจากแผนก/ฝ่าย ดู Dashboard</span>
                </div>
                    ...
                    <div class="list-group list-group-flush">
                        <a href="<?= Url::to(['/inventory-v2/receive/create']) ?>" class="list-group-item list-group-item-action d-flex align-items-center gap-3 py-3">
                            ...
                            <div class="flex-grow-1 min-w-0">
                                <span class="fw-semibold d-block">รับเข้าคลัง</span>
                                <span class="text-muted small">สร้างใบรับเข้า</span>
                            </div>
                        ...
                        <a href="<?= Url::to(['/inventory-v2/issue/index']) ?>" class="list-group-item list-group-item-action d-flex align-items-center gap-3 py-3">
                            ...
                            <div class="flex-grow-1 min-w-0">
                                <span class="fw-semibold d-block">รายการจ่ายพัสดุ</span>
                                <span class="text-muted small">ดำเนินการจ่ายตามใบขอเบิก</span>
                            </div>
                            <i class="bi bi-chevron-right text-muted flex-shrink-0"></i>
                        </a>
                        <a href="<?= Url::to(['/inventory-v2/stock-adjust/index']) ?>" class="list-group-item list-group-item-action d-flex align-items-center gap-3 py-3">
                            ...
                            <div class="flex-grow-1 min-w-0">
                                <span class="fw-semibold d-block">ปรับยอด stock</span>
                                <span class="text-muted small">เพิ่ม/ลดยอดคงเหลือโดยตรง (ตรวจนับหรือแก้ยอดผิด)</span>
                            </div>
                            <i class="bi bi-chevron-right text-muted flex-shrink-0"></i>
                        </a>
                        <a href="<?= Url::to(['/inventory-v2/main-stock/dashboard']) ?>" class="list-group-item list-group-item-action d-flex align-items-center gap-3 py-3">
                            ...
                            <div class="flex-grow-1 min-w-0">
                                <span class="fw-semibold d-block">Dashboard คลังหลัก</span>
                                <span class="text-muted small">ภาพรวมสต็อกและรายการรอจ่าย</span>
                            </div>
                            <i class="bi bi-chevron-right text-muted flex-shrink-0"></i>
                        </a>
                        <a href="<?= Url::to(['/inventory-v2/receive/index']) ?>" class="list-group-item list-group-item-action d-flex align-items-center gap-3 py-3">
                            ...
                            <div class="flex-grow-1 min-w-0">
                                <span class="fw-semibold d-block">ทะเบียนรับเข้า</span>
                                <span class="text-muted small">ดูประวัติใบรับเข้า</span>
                            </div>
                            <i class="bi bi-chevron-right text-muted flex-shrink-0"></i>
                        </a>
                    </div>
        ...
        <div class="col-12 col-lg-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-warning bg-opacity-10 border-0 py-2 px-3">
                    ...
                    <span class="text-muted small d-block mt-1">สร้างใบขอเบิกจากแผนก/ฝ่าย ดูสถานะและ Dashboard คลังย่อย</span>
                </div>
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        <a href="<?= Url::to(['/inventory-v2/requisition/create']) ?>" class="list-group-item list-group-item-action d-flex align-items-center gap-3 py-3">
                            ...
                            <div class="flex-grow-1 min-w-0">
                                <span class="fw-semibold d-block">สร้างใบขอเบิก</span>
                                <span class="text-muted small">ส่งคำขอเบิกจากคลังหลัก</span>
                            </div>
                            <i class="bi bi-chevron-right text-muted flex-shrink-0"></i>
                        </a>
                        <a href="<?= Url::to(['/inventory-v2/sub-stock/dashboard']) ?>" class="list-group-item list-group-item-action d-flex align-items-center gap-3 py-3">
                            ...
                            <div class="flex-grow-1 min-w-0">
                                <span class="fw-semibold d-block">Dashboard คลังย่อย</span>
                                <span class="text-muted small">ภาพรวมและรายการที่ส่งมา</span>
                            </div>
                            <i class="bi bi-chevron-right text-muted flex-shrink-0"></i>
                        </a>
                        <a href="<?= Url::to(['/inventory-v2/requisition/index']) ?>" class="list-group-item list-group-item-action d-flex align-items-center gap-3 py-3">
                            ...
                            <div class="flex-grow-1 min-w-0">
                                <span class="fw-semibold d-block">ทะเบียนใบขอเบิก</span>
                                <span class="text-muted small">ดูสถานะใบขอเบิกทั้งหมด</span>
                            </div>
                            <i class="bi bi-chevron-right text-muted flex-shrink-0"></i>
                        </a>
                    </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-12">
            <div class="card border-0 shadow-sm border-start border-warning border-3 h-100">
                <div class="card-header bg-warning bg-opacity-10 py-2 px-3 d-flex flex-wrap justify-content-between align-items-center gap-2">
                ...
                <div class="card-body py-2 px-3">
                    ...
                    <ol class="mb-0 ps-3 text-muted">
                        ...
                        <li>หัวหน้าอนุมัติที่ <?= Html::a('ทะเบียนใบขอเบิก', ['/inventory-v2/requisition/index']) ?></li>
                        <li>คลังหลักไปที่ <?= Html::a('รายการจ่ายพัสดุ', ['/inventory-v2/issue/index']) ?> → ดำเนินการจ่าย → ยืนยัน (ระบบตัดสต็อก)</li>
                        <li>ดูสถานะและรายการที่ส่งมาได้ที่ <?= Html::a('Dashboard คลังย่อย', ['/inventory-v2/sub-stock/dashboard']) ?></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12 col-sm-6 col-md-4">
                            <a href="<?= Url::to(['/inventory-v2/stock-item/index']) ?>" class="text-decoration-none d-flex align-items-center p-3 rounded border border-opacity-50 h-100">
                                <i class="bi bi-tags text-info me-2 flex-shrink-0"></i>
                                <span>จัดการรายการพัสดุ</span>
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4">
                            <a href="<?= Url::to(['/inventory-v2/stock-card/index']) ?>" class="text-decoration-none d-flex align-items-center p-3 rounded border border-opacity-50 h-100">
                                <i class="bi bi-journal-text text-secondary me-2 flex-shrink-0"></i>
                                <span>Stock Card</span>
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4">
                            <a href="<?= Url::to(['/inventory-v2/report/material-summary']) ?>" class="text-decoration-none d-flex align-items-center p-3 rounded border border-opacity-50 h-100">
                                <i class="bi bi-file-earmark-bar-graph text-primary me-2 flex-shrink-0"></i>
                                <span>สรุปรายงานวัสดุคงคลัง</span>
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4">
                            <a href="<?= Url::to(['/inventory-v2/default/setting']) ?>" class="text-decoration-none d-flex align-items-center p-3 rounded border border-opacity-50 h-100">
                                <i class="bi bi-gear text-secondary me-2 flex-shrink-0"></i>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="collapse" id="steps-detail">
                    <div class="card-body">
                        <ol class="mb-0 ps-3">
                            <li class="mb-3"><strong>จัดการข้อมูลพัสดุ</strong> — ไปที่ <?= Html::a('จัดการรายการพัสดุ', ['/inventory-v2/stock-item/index']) ?> เพิ่มรหัส ชื่อ หมวดหมู่ หน่วยนับ</li>
                            <li class="mb-3"><strong>คลังหลักรับเข้า</strong> — ไปที่ <?= Html::a('สร้างใบรับเข้า', ['/inventory-v2/receive/create']) ?> เลือกคลัง พัสดุ จำนวน Lot ราคา บันทึก</li>
                            <li class="mb-3"><strong>คลังย่อยขอเบิก</strong> — ไปที่ <?= Html::a('สร้างใบขอเบิก', ['/inventory-v2/requisition/create']) ?> เลือกคลังที่จ่าย แผนก/ฝ่ายที่รับ พัสดุและจำนวน ส่งคำขอ</li>
                            <li class="mb-3"><strong>หัวหน้าอนุมัติ → คลังหลักจ่าย</strong> — อนุมัติที่ <?= Html::a('ทะเบียนใบขอเบิก', ['/inventory-v2/requisition/index']) ?> จากนั้นไปที่ <?= Html::a('รายการจ่ายพัสดุ', ['/inventory-v2/issue/index']) ?> ดำเนินการจ่าย เลือก Lot และจำนวน ยืนยัน (ระบบตัดสต็อก)</li>
                            <li><strong>ตรวจสอบ</strong> — ดู <?= Html::a('Stock Card', ['/inventory-v2/stock-card/index']) ?> และ Dashboard</li>
                        </ol>
                    </div>
                </div>
            </div>
