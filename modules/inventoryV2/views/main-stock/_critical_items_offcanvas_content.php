...
$exportUrl = Url::to(['/inventory-v2/main-stock/export-critical-items-excel'] + $exportParams);
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-light py-2 px-3 d-flex justify-content-between align-items-center flex-wrap gap-2">
        <h6 class="mb-0 fw-normal text-muted">
            <i class="bi bi-exclamation-triangle-fill me-1 text-danger"></i>ต่ำกว่าจุดสั่งซื้อ
    ...
    <div class="card-body p-0">
        <div class="p-3 border-bottom">
            <div class="row g-2 align-items-end">
                <div class="col-12 col-lg">
                    <label class="form-label small text-muted mb-1" for="criticalItemsSearchQ">ค้นหาวัสดุ</label>
                    <input
                        type="text"
                        class="form-control form-control-sm"
                        id="criticalItemsSearchQ"
                        value="<?= Html::encode($q) ?>"
                ...
                <div class="col-12 col-lg-auto d-flex gap-2 justify-content-lg-end">
                    ...
                    <button type="button" class="btn btn-primary btn-sm critical-items-search-btn">
        ...
        <?php if (empty($items)): ?>
            <div class="p-4 text-center text-muted">
                ...
                <div class="mt-2 small">ไม่พบพัสดุที่ต่ำกว่าจุดสั่งซื้อ</div>
            </div>
        <?php else: ?>
                                ...
                                <div class="card-body p-3 d-flex align-items-center gap-3">
                                    ...
                                    <div class="min-w-0 flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-start gap-2">
                                            ...
                                            <div class="text-end">
                                                <div class="fw-semibold text-danger"><?= number_format((float)$r['current_qty'], 2) ?></div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center gap-2 mt-2">
                                            <div class="text-muted small">
                                                ...
                                                <span class="fw-semibold text-dark">
                                                    <?= number_format((float)$r['min_qty'], 2) ?>
                                                </span>
                                            </div>
                                            <div class="text-muted small">
