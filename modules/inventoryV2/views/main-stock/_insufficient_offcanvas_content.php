...
<?php if (empty($items)): ?>
    <div class="empty-block">
        ...
        <p class="empty-block__title">ไม่มีรายการพัสดุไม่พอจ่าย</p>
        <p class="empty-block__caption"><?= $q !== '' ? 'ลองล้างคำค้นเพื่อดูทั้งหมด' : 'ทุกใบเบิกที่รออยู่ ยอดในคลังพอจ่าย' ?></p>
    </div>
<?php else: ?>
                ...
                <div class="kpi-oc__row-link">
                    ...
                    <div class="kpi-oc__row-main">
                        ...
                        <div class="kpi-oc__row-meta">
                            ...
                            คงเหลือ <?= $fmtQty($r['balance_qty']) ?>
                            <span class="kpi-oc__row-sep" aria-hidden="true">·</span>
                            ขอ <?= $fmtQty($r['requested_qty']) ?>
                    ...
                    <div class="kpi-oc__row-fig">
                        <span class="kpi-oc__row-value kpi-oc__row-value--danger">−<?= $fmtQty($r['shortfall']) ?></span>
                        <span class="kpi-oc__row-unit">ขาด</span>
                    </div>
                </div>
            </li>
        <?php endforeach; ?>
