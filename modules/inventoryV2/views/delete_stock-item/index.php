...
<div class="card">
    <div class="card-body p-3">
        <div class="d-flex justify-content-between align-content-center">
            ...
            <div>
                <?= Html::a('<i class="bi bi-plus-circle me-2"></i>เพิ่มพัสดุใหม่', ['/inventory-v2/stock-item/create'], ['class' => 'btn btn-primary rounded-pill open-modal', 'data' => ['size' => 'modal-lg']]) ?>
                <!-- <button class="btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#itemModal"></button> -->
            </div>
