                ...
                <tbody class="table-group-divider">
                    <?php foreach ($dataProvider->getModels() as $key => $model): ?>
                        <tr>
                            ...
                            <td class="text-center ps-4 fw-bold text-primary"> <?= $model->code ?></td>
                            <td class="text-center">
                                <?php echo Html::img($model->ShowImg(),['class' => 'img-thumbnail','style' => 'width:100px'])?>
                            </td>
                            <td>
                                <div class="fw-bold">SSD 500GB Samsung</div>
                                <small class="text-muted">หมวดหมู่: <?= $model->ViewTypeName()['title'] ?></small>
                            </td>
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><?= Html::a('<i class="fa-solid fa-eye me-1"></i> แสดง', ['//inventory-v2/stock-item/view', 'id' => $model->id], ['class' => 'dropdown-item open-modal', 'data' => ['size' => 'modal-lg']]) ?></li>
                                        <li><?= Html::a('<i class="fa-regular fa-pen-to-square me-1"></i> แก้ไข', ['//inventory-v2/stock-item/update', 'id' => $model->id,'title' => '<i class="fa-regular fa-pen-to-square me-1"></i> แก้ไขวัสดุ'], ['class' => 'dropdown-item open-modal', 'data' => ['size' => 'modal-lg']]) ?></li>
                                        <li><?= Html::a('<i class="fa-solid fa-trash me-1"></i> ลบทิ้ง', ['//inventory-v2/stock-item/delete', 'id' => $model->id], ['class' => 'dropdown-item delete-item']) ?></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
