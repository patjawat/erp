...
<div class="requisition-view">
    ...
    <div class="alert <?= $model->status === 'CANCELLED' ? 'alert-danger' : 'alert-info' ?>">
        <div class="row">
            ...
            <div class="col-md-4">
                <strong>จากคลัง:</strong> <?= $model->fromWarehouse ? Html::encode($model->fromWarehouse->warehouse_name) : '(ไม่ได้ระบุ)' ?>
            </div>
            <div class="col-md-4">
                <strong>ไปยัง:</strong> <?= $model->toWarehouse ? Html::encode($model->toWarehouse->warehouse_name) : '(ไม่ได้ระบุ)' ?>
            </div>
        </div>
    </div>
            ...
            <tr>
                ...
                <td class="text-end">
                    <?php 
                        ...
                        $balance = $detail->item->getStockBalance($model->warehouse_id);
