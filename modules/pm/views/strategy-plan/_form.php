...
<div class="card border-0 shadow-sm"><div class="card-body p-4">
    <div class="row g-3">
        ...
        <div class="col-12"><?= $form->field($model, 'vision')->textarea(['rows' => 4, 'placeholder' => 'วิสัยทัศน์ขององค์กรในช่วงแผนนี้']) ?></div>
        <div class="col-12"><?= $form->field($model, 'source_note')->textarea(['rows' => 2, 'placeholder' => 'ชื่อไฟล์ Word/Excel หรือแหล่งข้อมูลต้นฉบับ']) ?></div>
    </div>
