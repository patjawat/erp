...
/** @var int $year @var array $years @var array $byStatus @var array $budgetByStatus */
/** @var array $byDept @var int $total @var float $budgetSum @var Projects[] $recent */

$this->title = 'ภาพรวมโครงการ';
...
<div class="pm-overview">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
        <?= Html::a('<i class="bi bi-list-ul me-1"></i> รายการโครงการ', ['/pm/projects/index'], ['class' => 'btn btn-sm btn-outline-primary']) ?>
                ...
                <div class="card-body">
                    <?php foreach ($statusList as $st => $label): ?>
                        ...
                        <div class="pm-status-row">
                            <span class="d-flex align-items-center gap-2"><span class="pm-dot <?= $badge ?>"></span><?= Html::encode($label) ?></span>
                            <span class="text-end">
