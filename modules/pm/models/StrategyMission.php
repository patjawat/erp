...
class StrategyMission extends StrategyRecord {
    ...
    public function rules(): array { return [[['plan_id','code','name'],'required'],[['plan_id','sort_order'],'integer'],['is_active','boolean'],['code','string','max'=>50],['name','string'],['code','unique','targetAttribute'=>['plan_id','code'],'message'=>'รหัสพันธกิจนี้ถูกใช้แล้วในชุดแผนเดียวกัน']]; }
