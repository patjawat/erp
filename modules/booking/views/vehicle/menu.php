...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
        ...
        <?= Html::a('<i class="bi bi-ui-checks me-2"></i> ทะเบียนการจัดสรรรถ (พขร.)', ['/booking/vehicle/work-official'], ['class' => 'dropdown-item']) ?>
    </div>
</li>

<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle <?= (isset($active) && $active == 'ambulance' ? 'active' : '') ?>" href="#"
        id="topnav-dashboard" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <i class="fa-solid fa-truck-medical me-2"></i> ขอใช้รถพยาบาล
        <i class="bx bx-chevron-down"></i>
    </a>
    <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
        <?= Html::a('<i class="bi bi-ui-checks me-2"></i> ทะเบียนคำขอใช้รถพยาบาล', ['/booking/vehicle/ambulance'], ['class' => 'dropdown-item']) ?>
        <?= Html::a('<i class="fa-regular fa-calendar me-2"></i> ปฏิทินขอใช้รถพยาบาล ', ['/booking/vehicle/calendar-ambulance'], ['class' => 'dropdown-item']) ?>
        <?= Html::a('<i class="bi bi-ui-checks me-2"></i> ทะเบียนการจัดสรรรถพยาบาล (พขร.)', ['/booking/vehicle/work-ambulance'], ['class' => 'dropdown-item']) ?>
    </div>
</li>
