                            ...
                            <div class="row g-2 align-items-start">
                                ...
                                <div class="col-12 col-lg-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-1 justify-content-end mt-2">
                                        ...
                                        <?= Html::a('<i class="fa-solid fa-print me-1"></i>พิมพ์', ['/booking/vehicle/print', 'id' => $item->id, 'title' => 'ใบขอใช้รถยนต์'], ['class' => 'btn btn-sm btn-outline-dark', 'target' => '_blank', 'rel' => 'noopener noreferrer', 'data-pjax' => '0', 'title' => 'ใช้เทมเพลตที่ตั้งค่าไว้สำหรับ «ขอใช้รถยนต์ส่วนกลาง»']) ?>
