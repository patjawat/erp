...
<div class="d-flex gap-2">
        ...
        <?php echo  Html::a('<i class="fa-solid fa-file"></i> ห้องประชุม<span class="badge rounded-pill badge-soft-primary text-primary fs-13 fw-semibold">0</span>',['/booking/room'],['class' => $path == 'booking/booking-car' ? 'btn btn-light' : 'btn btn-outline-light'])?>
