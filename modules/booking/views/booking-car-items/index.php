...
<div class="card">
    ...
    <div class="d-flex justify-content-between">
            ...
            <?php echo html::a('<i data-lucide="circle-plus"></i> เพิ่มข้อมูลขอใช้รถยนต์',['/booking/booking-car-items/create','title' => '<i data-lucide="circle-plus"></i> เพิ่มข้อมูลรถยนต์'],['class' => 'btn btn-primary rounded-pill shadow open-modal','data' => ['size' => 'modal-lg']])?>
        </div>
        <table class="table table-striped table-hover">
            ...
            <tbody class="align-middle table-group-divider">
                ...
                <tr class="">
                    <td>
                    <a href="<?php echo Url::to(['/booking/booking-car-items/view', 'id' => $item->id]);?>">
                    ...
                    <td class="text-center">
                        <div class="d-flex gap-2 justify-content-center">
                            <?php echo Html::a('<i class="fa-solid fa-eye fa-2x"></i>',['/booking/booking-car-items/view', 'id' => $item->id])?>
                            <?php echo Html::a('<i class="fa-solid fa-pencil fa-2x text-warning"></i>',['/booking/booking-car-items/update', 'id' => $item->id,'title' => '<i class="fa-solid fa-pencil"></i> แก้ไข'],['class' => 'open-modal','data' => ['size' => 'modal-lg']])?>
                        </div>
