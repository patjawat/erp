...
/**
 * MeetingStatusSearch represents the model behind the search form of `app\modules\booking\models\MeetingStatus`.
 */
class MeetingStatusSearch extends MeetingStatus
{
    /**
     * {@inheritdoc}
     */
