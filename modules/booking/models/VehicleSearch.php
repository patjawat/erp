...
class VehicleSearch extends Vehicle
{
    ...
    public function rules()
    {
        return [
            ...
            [['ref', 'code', 'vehicle_type_id','refer_type', 'urgent', 'license_plate', 'location', 'reason', 'status', 'date_start', 'time_start', 'date_end', 'time_end', 'driver_id', 'leader_id', 'emp_id', 'data_json', 'created_at', 'updated_at', 'deleted_at','q','q_department'], 'safe'],
