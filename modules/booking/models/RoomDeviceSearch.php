...
/**
 * RoomDeviceSearch represents the model behind the search form of `app\modules\booking\models\RoomDevice`.
 */
class RoomDeviceSearch extends RoomDevice
{
    /**
     * {@inheritdoc}
     */
