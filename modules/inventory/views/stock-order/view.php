                    ...
                    'attributes' => [
                        ...
                        [
                            ...
                            // 'value' => Html::a('<i class="fa-solid fa-print me-1"></i> เอกสารใบเบิก', ['/inventory/document/stock-order','id' => $model->id], ['target' => '_blank','data' => ['pjax' => false]])
                             'value' => $model->order_status == 'success' ? Html::a('<i class="fa-solid fa-print me-1"></i> เอกสารใบเบิก', ['/inventory/document/stock-order','id' => $model->id], ['class' => 'open-modal','data-pjax' => '0','data' => ['size' => 'modal-xl']]) : '',
                        ],
                    ],
                ]); ?>
