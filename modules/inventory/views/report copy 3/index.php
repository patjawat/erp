...
<div class="card">
    <div class="card-body">
        ...
        <?=Html::a('<i class="fa-solid fa-file-excel"></i> ส่งออกรายงาน',['/inventory/report/export-excel','warehouse_id' => $searchModel->warehouse_id,'receive_month' => $searchModel->receive_month,'thai_year' => $searchModel->thai_year],['class' => 'btn btn-primary shadow'])?>
