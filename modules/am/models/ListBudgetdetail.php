...
/**
 * Reference list: ประเภทเงิน (budget detail).
 * Backed by table `categorise` filtered by name='budget_type'.
 */
class ListBudgetdetail extends \yii\db\ActiveRecord
{
    const NAME = 'budget_type';
