...
use app\modules\am\models\FsnSearch;
...
/**
 * FsnTypeController implements the CRUD actions for Fsn model.
 */
class FsnTypeController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    public function actionIndex()
    {
        ...
        $dataProvider->query->where(['name' => 'asset_type','active' => true]);

        if ($this->request->get('view')) {
            \app\components\SiteHelper::setDisplay($this->request->get('view'));
        }
