...
use app\modules\am\models\Asset2Search;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * Asset2Controller implements the CRUD actions for Asset model.
 */
class Asset2Controller extends Controller
{
    ...
    {
        if (($model = Asset2::findOne(['id' => $id])) !== null) {
            return $model;
        }
