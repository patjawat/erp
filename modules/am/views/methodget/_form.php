...
<div class="list-setting-form list-methodget-form">
    <?php $form = ActiveForm::begin([
        'id' => 'form',
        'enableAjaxValidation' => true,
        'validationUrl' => $model->isNewRecord ? ['/am/methodget/validator'] : ['/am/methodget/validator', 'id' => $model->id],
        'options' => [
            'data-confirm-title' => 'ยืนยันการบันทึก?',
            'data-confirm-text' => 'คุณต้องการบันทึกวิธีได้มานี้ใช่หรือไม่',
