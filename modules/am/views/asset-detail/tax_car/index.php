...
<div class="d-flex justify-content-between">
    <?=app\components\AppHelper::Btn([
                    ...
                    'url' =>['/am/asset-detail/create','id'=> $id,'name' => 'tax_car','title' => '<i class="fa-solid fa-car-on"></i> ข้อมูลการต่อภาษี'],
                    'modal' =>true,
                    'size' => 'md',
            ])?>
    ...
    <table class="table table-striped mt-3">
        ...
        <tbody>
            ...
            <?php foreach($dataProvider->getModels() as $model):?>
                <?php
                    $startDate = AppHelper::DateFormDb($model->start_date);
                    $endDate = AppHelper::DateFormDb($model->end_date);
                    ?>
            <tr class="">
                <td>
                ...
                <div class="d-flex flex-column">
                <span>
                    <i class="bi bi-check2-circle"></i> <?=Yii::$app->thaiFormatter->asDate($model->start_date, 'medium')?>
            </span>
                    <span>
                    <i class="bi bi-stop-circle"></i> <?=Yii::$app->thaiFormatter->asDate($model->end_date, 'medium')?> 
            </span>
                </td>
                ...
                <td class="align-middle">
                    <?=Html::a('<i class="fa-regular fa-pen-to-square"></i>',['/am/asset-detail/update','id'=> $model->id,'title' => 'แก้ไขพ.ร.บ./ต่อภาษี'],['class' => 'btn btn-sm btn-warning open-modal','data' => ['size' => 'modal-lg']])?>
