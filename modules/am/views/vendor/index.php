...
/** @var app\modules\am\models\ListVendorSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'ผู้ขาย/ผู้จำหน่าย/ผู้บริจาค';
...
<div class="d-flex flex-column align-items-center align-items-lg-start gap-2 mb-2 text-center text-lg-start">
    <h4 class="fw-medium text-body d-flex align-items-center gap-2 mb-0">
        <span class="d-inline-flex align-items-center justify-content-center rounded-3"
              style="width:2.25rem;height:2.25rem;background:rgba(79,70,229,.14);color:#4338ca;">
            <i data-lucide="store"></i>
        </span>
        <?= Html::encode($this->title) ?>
    </h4>
    <small class="text-muted">รายชื่อผู้ขาย ผู้จำหน่าย ผู้บริจาค สำหรับใช้ในการลงทะเบียนทรัพย์สิน</small>
</div>
<?php $this->endBlock(); ?>
...
<div class="list-vendor-index">
    <?php Pjax::begin(['id' => 'pjax-vendor', 'timeout' => false]); ?>
        ...
        <div class="card-header text-white d-flex flex-wrap justify-content-between align-items-center gap-2 py-3 list-setting-header list-setting-header--indigo">
            <div class="d-flex align-items-center gap-3">
                <div class="list-setting-icon">
                    <i data-lucide="store" style="width:1.5rem;height:1.5rem;"></i>
                </div>
                <div>
            ...
            <?= Html::a('<i class="fa-solid fa-plus me-1"></i> เพิ่มผู้ขาย/ผู้จำหน่าย', ['create', 'title' => 'เพิ่มผู้ขาย/ผู้จำหน่าย'], [
        ...
        <div class="card-body p-0">
            <?php if ($total === 0): ?>
                <?= $this->render('@app/modules/am/views/_partials/list_setting_empty', [
                    'theme' => 'indigo',
                    'icon' => 'store',
                    'title' => 'ยังไม่มีผู้ขาย/ผู้จำหน่าย',
                    'subtitle' => 'เริ่มต้นเพิ่มผู้ขาย ผู้จำหน่าย หรือผู้บริจาคของหน่วยงาน',
                    'createUrl' => ['create', 'title' => 'เพิ่มผู้ขาย/ผู้จำหน่าย'],
                    'createLabel' => 'เพิ่มผู้ขายรายการแรก',
                ]) ?>
            <?php else: ?>
                                ...
                                <tr class="list-setting-row" style="--i:<?= $key ?>;">
                                    ...
                                    <td class="text-end pe-3">
                                        <div class="btn-group btn-group-sm" role="group">
                                            <?= Html::a('<i class="fa-regular fa-eye"></i>', ['view', 'id' => $model->id, 'title' => 'รายละเอียดผู้ขาย/ผู้จำหน่าย'], [
                                                'class' => 'btn btn-outline-secondary open-modal',
                                                'data' => ['size' => 'modal-md'],
                                                'title' => 'ดูรายละเอียด',
                                            ]) ?>
                                            <?= Html::a('<i class="fa-regular fa-pen-to-square"></i>', ['update', 'id' => $model->id, 'title' => 'แก้ไขผู้ขาย/ผู้จำหน่าย'], [
