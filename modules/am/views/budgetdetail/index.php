...
/** @var app\modules\am\models\ListBudgetdetailSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'ประเภทเงิน';
...
<div class="d-flex flex-column align-items-center align-items-lg-start gap-2 mb-2 text-center text-lg-start">
    <h4 class="fw-medium text-body d-flex align-items-center gap-2 mb-0">
        <span class="d-inline-flex align-items-center justify-content-center rounded-3"
              style="width:2.25rem;height:2.25rem;background:rgba(16,185,129,.12);color:#047857;">
            <i data-lucide="wallet"></i>
        </span>
        <?= Html::encode($this->title) ?>
    </h4>
    <small class="text-muted">รายการประเภทเงินสำหรับใช้กับการจัดซื้อ/รับเข้าทรัพย์สิน</small>
</div>
<?php $this->endBlock(); ?>
...
<?= $this->render('@app/modules/am/views/_partials/list_setting_styles', ['theme' => 'emerald']) ?>

<div class="list-budgetdetail-index">
    <?php Pjax::begin(['id' => 'pjax-budgetdetail', 'timeout' => false]); ?>

    <div class="card shadow-sm border-0 list-setting-card overflow-hidden">
        <div class="card-header text-white d-flex flex-wrap justify-content-between align-items-center gap-2 py-3 list-setting-header list-setting-header--emerald">
            ...
            <?= Html::a('<i class="fa-solid fa-plus me-1"></i> เพิ่มประเภทเงิน', ['create', 'title' => 'เพิ่มประเภทเงิน'], [
        ...
        <div class="card-body p-0">
            <?php if ($total === 0): ?>
                <?= $this->render('@app/modules/am/views/_partials/list_setting_empty', [
                    'theme' => 'emerald',
                    'icon' => 'wallet',
                    'title' => 'ยังไม่มีประเภทเงิน',
                    'subtitle' => 'เริ่มต้นเพิ่มประเภทเงิน เช่น งบประมาณ, งบค่าเสื่อม, เงินบริจาค',
                    'createUrl' => ['create', 'title' => 'เพิ่มประเภทเงิน'],
                    'createLabel' => 'เพิ่มประเภทเงินรายการแรก',
                ]) ?>
            <?php else: ?>
                    ...
                    <table class="table table-hover align-middle mb-0 list-setting-table">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th scope="col">ชื่อประเภทเงิน</th>
                        ...
                        <tbody class="table-group-divider">
                            <?php foreach ($models as $key => $model): ?>
                                <tr class="list-setting-row" style="--i:<?= $key ?>;">
                                    ...
                                    <td>
                                        <span class="badge bg-emerald-soft text-emerald fw-semibold font-monospace">
                                    ...
                                    <td class="text-center">
                                        <?php if ((int) $model->active === 1): ?>
                                            <span class="badge bg-emerald-soft text-emerald">
                                                <span class="status-dot status-dot--emerald me-1"></span>ใช้งาน
                                            </span>
                                        <?php else: ?>
                                    ...
                                    <td class="text-end pe-3">
                                        <div class="btn-group btn-group-sm" role="group">
                                            <?= Html::a('<i class="fa-regular fa-eye"></i>', ['view', 'id' => $model->id, 'title' => 'รายละเอียดประเภทเงิน'], [
                                                'class' => 'btn btn-outline-secondary open-modal',
                                                'data' => ['size' => 'modal-md'],
                                                'title' => 'ดูรายละเอียด',
                                            ]) ?>
                                            <?= Html::a('<i class="fa-regular fa-pen-to-square"></i>', ['update', 'id' => $model->id, 'title' => 'แก้ไขประเภทเงิน'], [
