...
?>
<style>
.asset-list-scroll { max-height: min(60vh, 600px); }
.asset-list-scroll thead th { position: sticky; top: 0; z-index: 1; background: #f8f9fa; box-shadow: 0 1px 0 0 rgba(0,0,0,.08); }
</style>
<div class="asset-list-scroll overflow-auto">
