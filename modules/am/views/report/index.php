...
echo GridView::widget([
    ...
    'panel' => [
        'after' => '<div class="float-right float-end"><button type="button" class="btn btn-primary"><i class="fas fa-download"></i> ดาวน์โหลด </button></div><div style="padding-top: 5px;"><em>* สรุปค่าเสื่อมทรัพย์สิน  เมษายน 2565.</em></div><div class="clearfix"></div>',
