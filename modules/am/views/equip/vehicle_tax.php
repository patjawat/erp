...
<div class="card mt-4">
    <div class="card-header">
        <?= $this->render('@app/modules/am/views/asset/_view_menu', ['model' => $model, 'menu' => 'vehicle-tax']) ?>
    </div>
    <div class="card-body">
        <div id="listVehicleTax"></div>
    </div>
</div>

<?php

$url = Url::to(['/am/vehicle-tax','code' => $model->code]);
$js = <<< JS

loadVehicleTax()
function loadVehicleTax()
{
    $.ajax({
        type: "get",
        url: "$url",
        ...
        success: function (res) {
            $('#listVehicleTax').html(res.content)
        }
    });
}
JS;
