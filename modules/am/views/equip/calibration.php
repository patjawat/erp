...
<div class="card mt-4">
    <div class="card-header">
        <?= $this->render('@app/modules/am/views/asset/_view_menu', ['model' => $model, 'menu' => 'calibration']) ?>
    </div>
    <div class="card-body">
        <div id="listCalibration"></div>
    </div>
</div>

<?php

$url = Url::to(['/am/calibration','code' => $model->code]);
$js = <<< JS
...
function loadCalibration()
{
    $.ajax({
        ...
        success: function (res) {
            $('#listCalibration').html(res.content)
        }
    });
}
JS;
