...
<div class="card mt-4">
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <?= Html::a('<i data-lucide="circle-plus"></i> เพิ่มเอกสาร', ['/am/asset-document/create','name' => 'asset_document','id' => $model->id], ['class' => 'btn btn-primary open-modal', 'data' => ['size' => 'modal-lg']]) ?>
        </div>
