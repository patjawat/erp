...
/** @var app\modules\am\models\ListPurchaseSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'วิธีการได้มา';
...
<div class="d-flex flex-column align-items-center align-items-lg-start gap-2 mb-2 text-center text-lg-start">
    <h4 class="fw-medium text-body d-flex align-items-center gap-2 mb-0">
        <span class="d-inline-flex align-items-center justify-content-center rounded-3"
              style="width:2.25rem;height:2.25rem;background:rgba(217,119,6,.14);color:#b45309;">
            <i data-lucide="hand-coins"></i>
        </span>
        <?= Html::encode($this->title) ?>
    </h4>
    <small class="text-muted">รายการวิธีการได้มา/วิธีจัดซื้อจัดจ้าง (e-bidding, เฉพาะเจาะจง ฯลฯ)</small>
</div>
<?php $this->endBlock(); ?>
...
<?= $this->render('@app/modules/am/views/_partials/list_setting_styles', ['theme' => 'amber']) ?>

<div class="list-purchase-index">
    <?php Pjax::begin(['id' => 'pjax-purchase', 'timeout' => false]); ?>

    <div class="card shadow-sm border-0 list-setting-card overflow-hidden">
        <div class="card-header text-white d-flex flex-wrap justify-content-between align-items-center gap-2 py-3 list-setting-header list-setting-header--amber">
            <div class="d-flex align-items-center gap-3">
                <div class="list-setting-icon">
                    <i data-lucide="hand-coins" style="width:1.5rem;height:1.5rem;"></i>
                </div>
                <div>
            ...
            <?= Html::a('<i class="fa-solid fa-plus me-1"></i> เพิ่มวิธีการได้มา', ['create', 'title' => 'เพิ่มวิธีการได้มา'], [
        ...
        <div class="card-body p-0">
            <?php if ($total === 0): ?>
                <?= $this->render('@app/modules/am/views/_partials/list_setting_empty', [
                    'theme' => 'amber',
                    'icon' => 'hand-coins',
                    'title' => 'ยังไม่มีวิธีการได้มา',
                    'subtitle' => 'เริ่มต้นเพิ่มวิธีการได้มา เช่น ตกลงราคา, e-bidding, เฉพาะเจาะจง',
                    'createUrl' => ['create', 'title' => 'เพิ่มวิธีการได้มา'],
                    'createLabel' => 'เพิ่มวิธีการได้มารายการแรก',
                ]) ?>
            <?php else: ?>
                    ...
                    <table class="table table-hover align-middle mb-0 list-setting-table">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th scope="col">ชื่อวิธีการได้มา</th>
                        ...
                        <tbody class="table-group-divider">
                            <?php foreach ($models as $key => $model): ?>
                                <tr class="list-setting-row" style="--i:<?= $key ?>;">
                                    ...
                                    <td>
                                        <span class="badge bg-amber-soft text-amber fw-semibold font-monospace">
                                    ...
                                    <td class="text-center">
                                        <?php if ((int) $model->active === 1): ?>
                                            <span class="badge bg-amber-soft text-amber">
                                                <span class="status-dot status-dot--amber me-1"></span>ใช้งาน
                                            </span>
                                        <?php else: ?>
                                    ...
                                    <td class="text-end pe-3">
                                        <div class="btn-group btn-group-sm" role="group">
                                            <?= Html::a('<i class="fa-regular fa-eye"></i>', ['view', 'id' => $model->id, 'title' => 'รายละเอียดวิธีการได้มา'], [
                                                'class' => 'btn btn-outline-secondary open-modal',
                                                'data' => ['size' => 'modal-md'],
                                                'title' => 'ดูรายละเอียด',
                                            ]) ?>
                                            <?= Html::a('<i class="fa-regular fa-pen-to-square"></i>', ['update', 'id' => $model->id, 'title' => 'แก้ไขวิธีการได้มา'], [
