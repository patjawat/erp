...
<div class="d-flex gap-2">
    ...
    <?= Html::a('<i class="fa-solid fa-circle-down me-1 text-success"></i> ตรวจรับ', ['/inventory/stock-in'], ['class' => 'btn btn-light']) ?>
    <?= Html::a('<i class="fa-solid fa-circle-down me-1 text-success"></i> เบิกคลัง', ['/inventory/withdraw'], ['class' => 'btn btn-light']) ?>
