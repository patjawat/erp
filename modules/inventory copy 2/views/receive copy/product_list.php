        ...
        <tbody>
            ...
            <tr class="">
                ...
                <td class="align-middle">
                    <?php echo Html::a('<i class="bi bi-bag-plus"></i> เลือก', ['/inventory/receive/add-item', 'title' => $item->title, 'asset_item' => $item->code, 'id' => $model->id], ['class' => 'btn btn-sm btn-primary rounded-pill shadow text-center open-modal','data' => ['size' => 'modal-lg']]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
