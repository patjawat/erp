        ...
        <tbody class="table-group-divider">
            <?php foreach ($models as $model): ?>
                <tr class="">
                    ...
                    <td class="text-end">
                    <?php   echo Html::a('ดำเนินการ', ['/inventory/receive/by-order', 'po_number' =>  $model->po_number, 'receive_type' => 'purchase', 'title' => '<i class="fa-solid fa-file-circle-plus"></i> รับสินค้าจากใบสั่งซื้อ'], ['class' => 'btn btn-sm btn-primary shadow rounded-pill open-modal', 'data' => ['size' => 'modal-md']]) ?>
