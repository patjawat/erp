...
<?= $form->field($model, 'data_json[product_name]')->hiddenInput(['value' => $model->product->title])->label(false); ?>
<?= $form->field($model, 'data_json[unit]')->hiddenInput(['value' => isset($model->product->data_json['unut']) ? $model->orderItem->product->data_json['unut'] : null])->label(false); ?>
<?= $form->field($model, 'data_json[product_type_name]')->hiddenInput(['value' => $model->product->productType->title])->label(false); ?>
