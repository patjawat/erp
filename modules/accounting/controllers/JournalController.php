...
{
    public function behaviors(){return array_merge(parent::behaviors(),['access'=>['class'=>AccessControl::class,'rules'=>[['allow'=>true,'actions'=>['index','view'],'roles'=>['accountingView']],['allow'=>true,'actions'=>['create'],'roles'=>['accountingPrepare']],['allow'=>true,'actions'=>['post'],'roles'=>['accountingPost']],['allow'=>true,'actions'=>['settings'],'roles'=>['accountingChartManage']]]],'verbs'=>['class'=>VerbFilter::class,'actions'=>['create'=>['POST'],'post'=>['POST'],'settings'=>['GET','POST']]]]);}
