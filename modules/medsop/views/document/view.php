...
<section class="medsop-document-hero mb-4" aria-label="ข้อมูลเอกสาร">
    ...
    <div class="medsop-document-hero__context"><div class="medsop-qr"><img src="<?= Html::encode($qrCode->writeDataUri()) ?>" width="156" height="156" alt="คิวอาร์โค้ดสำหรับเปิดเอกสารนี้"><span>สแกนเพื่อเปิดอ่านบนมือถือ</span></div><div class="medsop-document-purpose"><h2>วัตถุประสงค์</h2><div class="medsop-richtext"><?= RichText::render($model->objective) ?></div><?php if ($model->scope): ?><h2>ขอบเขตการใช้งาน</h2><div class="medsop-richtext"><?= RichText::render($model->scope) ?></div><?php endif; ?></div></div>
</section>
