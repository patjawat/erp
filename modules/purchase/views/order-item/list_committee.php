...
<table class="table">
    <thead class="table-primary">
        <tr>
            <th scope="col"><?= Html::a('<i class="bi bi-plus-circle me-1"></i> เลือกกรรรมการ', ['/purchase/order-item/create', 'id' => $model->id, 'name' => 'committee', 'title' => '<i class="bi bi-pencil-square"></i> กรรมการตรวจรับ'], ['class' => 'btn btn-sm btn-primary open-modal', 'data' => ['size' => 'modal-md']]) ?></th>
        ...
        <tr class="">
            ...
            <td class="align-middle">
                <div class="d-flex gap-2">
                    ...
                    <?= Html::a('<i class="bi bi-pencil-square"></i>', ['/purchase/order-item/update', 'id' => $item->id, 'name' => 'committee', 'title' => '<i class="bi bi-pencil-square"></i> กรรมการตรวจรับ'], ['class' => 'btn btn-sm btn-warning open-modal', 'data' => ['size' => 'modal-md']]) ?>
