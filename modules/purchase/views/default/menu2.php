...
<div class="card">
    <div class="card-body d-flex flex-lg-row flex-md-row flex-sm-column flex-sx-column justify-content-lg-between justify-content-md-between justify-content-sm-center">
        <div class="d-flex gap-3 justify-content-start">
            <div class="btn-group">
            <?= Html::a('<i class="fa-solid fa-business-time"></i> ใบขอซื้อ', ['/purchase/pr-order', 'name' => 'pr'], ['class' => 'btn btn-light']) ?>
            ...
            <div class="btn-group">
            <?= Html::a('<i class="fa-solid fa-basket-shopping"></i> ใบสั่งซื้อ', ['/purchase/po-order', 'name' => 'po'], ['class' => 'btn btn-light']) ?>
                <button type="button" class="btn btn-light dropdown-toggle dropdown-toggle-split"
                    data-bs-toggle="dropdown" aria-expanded="false" data-bs-reference="parent">
                    <i class="bi bi-caret-down-fill"></i>
                </button>
