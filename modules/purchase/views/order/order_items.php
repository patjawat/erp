        ...
        <thead class="table-primary">
            <tr>
                <th style="width:500px">
                    <?= Html::a('<i class="bi bi-plus-circle text-white"></i> เลือกรายการ', ['/purchase/order/product-list', 'order_id' => $model->id, 'title' => '<i class="bi bi-plus-circle text-primary"></i> เลือกรายการ ' . $orderTypeName], ['class' => 'btn btn-sm btn-primary open-modal shadow', 'data' => ['size' => 'modal-xl']]) ?>
                </th>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            <!-- <td class="text-end"><span class="fw-semibold"><?php //  number_format($model->calculateVAT()['priceAfterVAT'],2) 
                                                                                ?></span> -->
