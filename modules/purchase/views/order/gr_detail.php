...
<?php else:?>
    ...
    <?=Html::a('<i class="bi bi-plus-circle text-white"></i> สร้างใบตรวจรับ',['/purchase/gr-order/update','id' => $model->id,'title' => '<i class="bi bi-plus-circle text-primary"></i> ตรวจรับ'],['class' => 'btn btn-primary shadow text-center open-modal','data' => ['size' => 'modal-xl']])?>
</div>
<?php endif;?>