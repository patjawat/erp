...
<div class="mt-3">
    <div class="step  <?= $model->status >= 1 ? 'step-active' : '' ?>">
        <div>
            <div class="circle"><?= $model->status == 1 ? '<i class="fa-solid fa-check"></i>' : '<i class="fa-solid fa-check"></i>' ?></div>
        </div>
        <div>
    ...
    <div class="step  <?= $model->status > 2 ? 'step-active' : '' ?>">
        <div>
        <div class="circle"><?= $model->status == 1 ? '<i class="fa-solid fa-clock"></i>' : '<i class="fa-solid fa-check"></i>' ?></div>
        </div>
        <div>
...
<?= isset($model->data_json['pr_confirm_2']) ? $model->data_json['pr_confirm_2'] : '' ?>
    ...
    <div class="step  <?= $model->status == 3 ? 'step-warning' : '' ?>">
        <div>
        <div class="circle"><?= $model->status == 3 ? '<i class="fa-regular fa-clock"></i>' : '<i class="fa-solid fa-check"></i>' ?></div>
        </div>
        <div>
    ...
    <div class="step  <?= $model->status == 4 ? 'step-warning' : '' ?>">
        <div>
        <div class="circle"><?= $model->status == 4 ? '<i class="fa-regular fa-clock"></i>' : '<i class="fa-solid fa-check"></i>' ?></div>
        </div>
        <div>
    ...
    <div class="step  <?= $model->status == 5 ? 'step-active' : '' ?>">
        <div>
        <div class="circle"><?= $model->status == 5 ? '<i class="fa-regular fa-clock"></i>' : '5' ?></div>
        </div>
        <div>
    ...
    <div class="step  <?= $model->status == 6 ? 'step-active' : '' ?>">
        <div>
        <div class="circle"><?= $model->status == 6 ? '<i class="fa-regular fa-clock"></i>' : '6' ?></div>
        </div>
        <div>
    ...
    <div class="step  <?= $model->status == 7 ? 'step-active' : '' ?>">
        <div>
        <div class="circle"><?= $model->status == 7 ? '<i class="fa-regular fa-clock"></i>' : '7' ?></div>
        </div>
        <div>
    ...
    <div class="step  <?= $model->status == 8 ? 'step-active' : '' ?>">
        <div>
        <div class="circle"><?= $model->status == 8 ? '<i class="fa-regular fa-clock"></i>' : '8' ?></div>
        </div>
        <div>
    ...
    <div class="step  <?= $model->status == 9 ? 'step-active' : '' ?>">
        <div>
        <div class="circle"><?= $model->status == 9 ? '<i class="fa-regular fa-clock"></i>' : '9' ?></div>
        </div>
        <div>
    ...
    <div class="step  <?= $model->status == 10 ? 'step-active' : '' ?>">
        <div>
        <div class="circle"><?= $model->status == 10 ? '<i class="fa-regular fa-clock"></i>' : '10' ?></div>
        </div>
        <div>
