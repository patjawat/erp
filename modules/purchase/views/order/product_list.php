        ...
        <tbody class="align-middle table-group-divider">
            ...
            <tr class="">
                ...
                <td class="align-middle">
                    <?php echo Html::a('<i class="fa-solid fa-circle-plus"></i> เลือก', ['/purchase/order/add-item', 'title' => $item->title, 'asset_item' => $item->code, 'code' => $model->code, 'order_id' => $model->id], ['class' => 'btn btn-sm btn-primary shadow text-center open-modal']); ?>
                </td>
            </tr>
            <?php } ?>
        </tbody>
