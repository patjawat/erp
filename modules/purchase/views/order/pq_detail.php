...
<?php else:?>
    ...
    <?=Html::a('<i class="fa-solid fa-circle-plus text-white"></i> สร้างทะเบียนคุม',['/purchase/pq-order/update','id' => $model->id,'title' => '<i class="fa-solid fa-circle-plus text-primary"></i> สร้างทะเบียนคุม'],['class' => 'btn btn-primary shadow text-center open-modal','data' => ['size' => 'modal-xl']])?>
</div>
<?php endif;?>