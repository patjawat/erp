    ...
    <tbody>
        <tr class="">
            ...
            <td>
                ...
                echo Yii::$app->thaiFormatter->asDateTime($data['pr_create_date'] ?? null, 'medium') ?: '-';
                ?>
            </td>
        </tr>
        <tr class="">
...
<div class="d-flex justify-content-center mt-3">
    <?= Html::a('<i class="bi bi-pencil-square"></i> แก้ไข', ['/purchase/pr-order/update', 'id' => $model->id, 'title' => '<i class="bi bi-pencil-square"></i> แก้ไขคำขอซื้อ'], ['class' => 'btn btn-warning shadow text-center open-modal', 'data' => ['size' => 'modal-xl']]) ?>
</div>