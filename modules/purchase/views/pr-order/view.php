    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            ...
            <div class="d-flex justify-content-between">
                    <h5><i class="fa-solid fa-circle-info text-primary"></i> ใบขอซื้อ/ขอจ้าง</h5>
                ...
                <div class="border border-secondary border-opacity-25 p-3 rounded">
                    ...
                    <ul class="nav nav-tabs" role="pillist" style="visibility: visible;">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="pill" href="#home1" role="pill"><i class="fa-solid fa-circle-info"></i> รายละเอียดการขอซื้อ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="pill" href="#menu12" role="pill"><i class="fa-solid fa-user-tag"></i> กรรมการกำหนดรายละเอียด</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="pill" href="#menu22" role="pill"><i class="fa-solid fa-users"></i> กรรมการตรวจรับ</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content p-0">
                        ...
                        <div id="menu22" class="container tab-pane fade">
                            <?= $this->render('list_committee_detail', ['model' => $model]) ?>
                        </div>
                    </div>
                </div>

                <div class="d-flex justify-content-between mt-5">
                    <h5><i class="fa-solid fa-circle-info text-primary"></i> รายการขอซื้อ/ขอจ้าง</h5>
                    <div class="dropdown float-end">
                        <a href="javascript:void(0)" class="rounded-pill dropdown-toggle me-0" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <i class="fa-solid fa-ellipsis"></i>
