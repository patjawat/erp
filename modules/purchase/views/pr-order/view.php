    ...
    <div class="col-lg-8 col-md-8 col-sm-12">
        ...
        <div class="d-flex justify-content-between pe-3">
            ...
            <ul class="nav nav-pills p-4>
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="pill" href="#home"><i class="fa-solid fa-circle-info"></i> ข้อมูลขอซื้อ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="pill" href="#menu1"><i class="fa-solid fa-list-ul"></i> รายการ</a>
                </li>
