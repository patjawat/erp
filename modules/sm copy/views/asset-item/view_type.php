...
<div class="card">
    ...
    <div class="d-flex gap-2">
                <?=Html::a('<i class="fa-solid fa-gear me-1"></i> ตั้งค่ากลุ่มครุภัณฑ์',['/sm/asset-type','group' => 3,'title' => 'ตั้งค่าครุภัณฑ์'],['class' => 'btn btn-light'])?>
                <?=Html::a('<i class="fa-solid fa-gear me-1"></i> ตั้งค่ากลุ่มวัสดุ',['/sm/asset-type','group' => 4,'title' => 'ตั้งค่าวัสดุ'],['class' => 'btn btn-light'])?> 
        </div>
