...
<div class="row">
    <div class="col-3">
        <div class="text-bg-light p-3 rounded-2">
            <div class="d-flex justify-content-between gap-1 mb-0">
                <span class="h5 fw-semibold"><i class="bi bi-currency-dollar"></i><?=number_format($pr['price'],2);?> บาท</span>
                <i class="bi bi-plus-circle-fill text-black-50"></i>
            </div>
            <div class="d-flex justify-content-between gap-1 mb-0">
                <?=Html::a('ขอซื้อ-ขอจ้าง',['/purchase/pr-order'])?>
                <span class="text-black bg-primary-subtle badge rounded-pill fw-ligh fs-13"><?=$pr['total'];?></span>
            </div>
        </div>
    </div>
    <div class="col-3">
        <div class="text-bg-light p-3 rounded-2">
            <div class="d-flex justify-content-between gap-1 mb-0">
                <span class="h5 fw-semibold"><i class="bi bi-currency-dollar"></i><?=number_format($pq['price'],2)?> บาท</span>
    ...
    <div class="col-3">
        <div class="text-bg-light p-3 rounded-2">
            <div class="d-flex justify-content-between gap-1 mb-0">
                <span class="h5 fw-semibold"><i class="bi bi-currency-dollar"></i><?=number_format($po['price'],2)?> บาท</span>
    ...
    <div class="col-3">
        <div class="text-bg-light p-3 rounded-2">
            <div class="d-flex justify-content-between gap-1 mb-0">
                <span class="h5 fw-semibold"><i class="bi bi-currency-dollar"></i><?=number_format($success['price'],2)?></span>
