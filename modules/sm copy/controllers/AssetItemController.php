...
class AssetItemController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new AssetItemSearch();
        $dataProvider = $searchModel->search($this->request->queryParams);
        $dataProvider->query->where(['name' => 'asset_item','group_id' => 'EQUIP','active' => true]);
        if($model){
            $dataProvider->query->andFilterWhere(['name' => 'asset_item','group_id' => 'EQUIP','active' => true]);
            
        }
        
        $dataProviderGroup = $searchModel->search($this->request->queryParams);
        $dataProviderGroup->query->andFilterWhere(['name' => 'asset_item','group_id' => 'EQUIP','active' => true]);
