...
/**
 * ProductTypeSearch represents the model behind the search form of `app\modules\sm\models\ProductType`.
 */
class ProductTypeSearch extends ProductType
{
    ...
    public function rules()
    {
        return [
            ...
            [['ref', 'category_id', 'code', 'emp_id', 'name', 'title', 'description', 'data_json', 'unit_items', 'ma_items','q'], 'safe'],
        ];
    }
