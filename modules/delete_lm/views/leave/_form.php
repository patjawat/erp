                            ...
                            <div class="w-50">
                                <?= $form->field($model, 'date_start')->widget(Datetimepicker::className(), [
                                    'options' => [
                                        ...
                                        'yearOffset' => 543,
                                        'format' => 'd/m/Y',   
                                        'minDate' => 0,//วันนี้และอนาคตเท่านั้น   
                                    ],              
                                    ])->label('ตั้งแต่วันที่') ?>
                            </div>
                            <div class="w-50">
  ...
  function calDays()
    {
        $.ajax({
            ...
            success: function (res) {
                var data = res.data;
               console.log(data);
               $('#summaryDay').text(data.summaryDay)
