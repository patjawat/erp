                    ...
                    <tr>
                        ...
                        <td>
                            <div class="avatar-detail">
                                <p class="mb-0 fs-13 fw-semibold"><?= $item->showDateRange() ?> เวลา <?= $item->viewTime()['full'] ?></p>
                                <p class="mb-0 fs-12"><?= $item->viewGoType() ?> : <?= $item->locationOrg?->title ?? '-' ?></p>
                            </div>
                        </td>
                        
                        <td><p class="mb-0 fs-13"><?= $item->reason; ?></p></td>
                        <td class="text-center"><p class="mb-0 fs-13"><?= $item->viewUrgent() ?></p></td>
                        <td>
