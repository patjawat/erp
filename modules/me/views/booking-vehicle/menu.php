...
<div class="d-flex gap-2">
        <?php echo  Html::a('<i class="fa-solid fa-calendar"></i> ปฏิทินการใช้รถยนต์ทั่วไป',['/me/booking-vehicle/calendar'],['class' => 'btn btn-light '.(isset($active) && $active =='official' ? 'active' : '')])?>
