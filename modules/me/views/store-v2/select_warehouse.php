...
<?php echo $this->render('@app/modules/me/views/store-v2/menu_store') ?>
<?php $this->endBlock(); ?>
    ...
    <?php foreach($dataProvider->getModels() as $model):?>
        ...
        <div class="p-2 bg-white rounded transform transition-all hover-translate-y-n2 duration-300 shadow-lg hover-shadow mt-3 zoom-in">
            ...
            <div class="d-grid gap-2 m-2" id="selectWarehouse<?= $model->id ?>">
                ...
                <?= html::a(' <i class="bi bi-shop fs-3"></i> เลือกคลัง', ['/me/store-v2/set-warehouse'], [
            ...
            $.ajax({
                ...
                success: function (response) {
                    if(response.status == 'success'){
                        ...
                        window.location.href = '/me/store-v2/index';
                    });
                    }
