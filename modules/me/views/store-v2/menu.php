...
<div class="d-flex gap-2">
        <?php echo  Html::a('<i class="fa-solid fa-gauge"></i> Dashboard <span class="badge rounded-pill badge-soft-primary text-primary fs-13 fw-semibold"></span>',['/me/store-v2/dashboard','name' => 'leave'],['class' => 'btn btn-primary'])?>
        <?php echo  Html::a('<i class="fa-solid fa-cube"></i>  สต๊อก/เบิกใช้งาน',['/me/store-v2/index'],['class' => 'btn btn-primary'])?>
        ...
        <?php echo  Html::a('<i class="bi bi-shop"></i> เบิกวัสดุคลังหลัก',['/me/main-stock/store'],['class' => 'btn btn-primary'])?>
