...
.field-leave-data_json-date_start_type {
    margin-top: 34px;
}

.field-leave-data_json-date_end_type {
    margin-top: 50px;
}
</style>
        ...
        <div class="row">
            <div class="col-6">
                <?= $form->field($model, 'leave_type_id')->widget(Select2::classname(), [
                        ...
                        ?>
                <?= $form->field($model, 'data_json[reason]')->textArea(['style' => 'height:115px;'])->label('เหตุผล/เนื่องจาก') ?>
                <?= $form->field($model, 'data_json[address]')->textArea(['style' => 'height:115px;'])->label('ระหว่างลาติดต่อ') ?>
            </div>
            <div class="col-6">
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <?=$form->field($model, 'data_json[date_start_type]')->radioList([
                                'เต็มวัน' => 'เต็มวัน',
                                'ครึงวันบ่าย' => 'ครึงวันบ่าย',
                            ], ['inline' => true])->label(false)?>
                        <?=$form->field($model, 'data_json[date_end_type]')->radioList([
                                        'เต็มวัน' => 'เต็มวัน',
