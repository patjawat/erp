...
<table class="table table-primary">
    ...
    <tbody class="align-middle table-group-divider">
        ...
        <tr class="<?=($item->getQuantity() > $item->SumQty()) ? 'badge-soft-danger' : ''?>">
            ...
            <td>
                <?=Html::a('<i class="fa-solid fa-trash"></i>',['/me/sub-stock/delete-item','id' => $item->id],['class' => 'delete-sub-item-cart btn btn-sm btn-danger shadow '])?>
            </td>
        </tr>
        <?php endforeach;?>
        <tr>
...
<div class="text-center">
    ...
    <?php else:?>
    <?php echo  $cart->getCount() > 0 ? Html::a('<i class="fa-solid fa-cart-shopping"></i> บันทึกเบิก', ['/me/sub-stock/check-out','name' => 'order','type' => 'OUT','title' => 'เบิกวัสดุ'], ['class' => 'btn btn-primary rounded-pill shadow position-relative open-modal checkout','data' => ['size' => 'modal-ld']]) : '' ?>
    <?php endif?>
