            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="row">
                            <div class="col-8">
                                <?= $form->field($model, 'date_start')->textInput()->label('ต้องการใช้รถตั้งแต่วันที่') ?>
                                <?= $form->field($model, 'date_end')->textInput()->label('ถึงวันที่') ?></div>
                            <div class="col-4">
                ...
                <?= $form->field($model, 'data_json[reason]')->textArea(['rows' => 5])->label('เหตุผล') ?>
                <?php
...
$js = <<<JS
      ...
      thaiDatepicker('#bookingcar-date_start,#bookingcar-date_end')

      \$('#bookingcar-date_start').on('change', function() {
            var dateStart = \$('#bookingcar-date_start').val();
            var dateEnd = \$('#bookingcar-date_end').val();
    ...
    function listCars(dateStart,dateEnd)
    {
        \$.ajax({
            type: "get",
            url: "$listCarsUrl",
