...
<div class="card">
    <div class="card-body p-2 p-md-3"> <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-3">
        ...
        <div class="table-responsive">
            <table class="table table-striped align-middle">
                <thead>
                    <tr class="text-nowrap"> <th class="text-center" style="width:50px;">ลำดับ</th>
