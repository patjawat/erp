                    ...
                    <td class="fw-light align-middle">
                        ...
                        <div>
                                        <p class="text-primary fw-semibold fs-13 mb-0">
                                            <?php if($item->document && $item->document->doc_speed == 'ด่วนที่สุด'):?>
                                                    <span class="badge text-bg-danger fs-13">
                                                        <i class="fa-solid fa-circle-exclamation"></i> ด่วนที่สุด
                                                    </span>
                                            <?php endif;?>
                                            
                                            <?php if($item->document && $item->document->secret == 'ลับที่สุด'):?>
                ...
                <tr class="">
                    ...
                    <td class="fw-light align-middle">
                        <div class=" d-flex flex-column">
                            <span class="fw-normal fs-6"><?php echo $item->document?->viewDocDate()?></span>
                            <span
                                class="fw-lighter fs-13"><?php echo $item->document?->doc_date ?  AppHelper::timeDifference($item->document?->doc_date) : '-'?></span>
                        </div>
                    </td>
                </tr>
                <?php endforeach;?>
