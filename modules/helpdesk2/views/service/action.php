...
<div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li><?=Html::a('<i class="fa-solid fa-file-pdf me-2"></i>พิมพ์ใบส่งซ่อม (PDF)',['/helpdesk/service/print-send-repair-pdf','id' => $item->id],['class' => 'dropdown-item','target' => '_blank',])?></li>
