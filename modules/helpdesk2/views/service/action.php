...
<div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="">
                                    ...
                                    <li><?=Html::a('<i class="fa-solid fa-print me-2"></i>พิมพ์ใบส่งซ่อม',['/helpdesk/service/print','id' => $item->id,'title' => 'รายละเอียดการแจ้งซ่อม #'.$item->repair_number],['class' => 'dropdown-item','data' => ['size' => 'modal-xl']])?></li>
