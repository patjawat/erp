...
<?php if ($models === []): ?><tr><td colspan="6" class="text-center py-5"><strong>ยังไม่มีคำขอคืนบ้านพัก</strong><div class="small text-body-secondary mt-1">คำขอจากผู้พักจะแสดงที่หน้านี้</div></td></tr><?php endif; ?>
</tbody></table></div>
