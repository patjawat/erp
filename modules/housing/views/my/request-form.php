...
<div class="container-fluid py-3">
    <div class="card border-0 shadow-sm"><div class="card-body">
        ...
        <div class="d-flex justify-content-end gap-2"><?= Html::submitButton('บันทึกร่าง', ['class' => 'btn btn-light']) ?><?= Html::submitButton('ส่งคำขอ', ['class' => 'btn btn-primary', 'name' => 'submit', 'value' => '1']) ?></div>
        <?php ActiveForm::end(); ?>
    </div></div>
</div>
