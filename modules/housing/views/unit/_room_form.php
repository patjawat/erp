...
<div class="mt-3 d-flex justify-content-end gap-2"><?= Html::button('ยกเลิก', ['class' => 'btn btn-outline-secondary', 'data-bs-dismiss' => 'modal']) ?><?= Html::submitButton($model->isNewRecord ? 'เพิ่มห้อง' : 'บันทึกห้อง', ['class' => 'btn btn-primary']) ?></div>
<?php ActiveForm::end();
