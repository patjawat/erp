...
<td><?php if ($model->rooms): foreach ($model->rooms as $room): ?><?= Html::a(Html::encode($room->code), ['view', 'id' => $model->id, 'room_id' => $room->id], ['class' => 'badge bg-body-secondary text-body text-decoration-none me-1', 'title' => 'ดูรายละเอียดห้อง']) ?><?php endforeach; else: ?><span class="text-muted">—</span><?php endif; ?></td>
