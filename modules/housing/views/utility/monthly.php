...
<?php if($accounts&&$period->status==='open'):?><?=Html::a('<i class="bi bi-lock"></i> ปิดค่าใช้จ่ายประจำเดือน',['close-period','id'=>$period->id],['class'=>'btn btn-outline-danger','data-method'=>'post','data-confirm'=>'เมื่อปิดรอบแล้วจะไม่สามารถแก้ไขข้อมูลได้ ยืนยันหรือไม่?'])?><?php endif;?></div>
</div>
