...
<style>
.charge-types-page{--u-bg:#f7fafc;--u-soft:#eef5ff;--u-border:#dce6f0;--u-ink:#26384a;--u-primary:#4c84c6;color:var(--u-ink)}
.charge-types-page .soft-panel{background:#fff;border:1px solid var(--u-border);border-radius:.85rem}
.charge-types-page .method-pill{display:inline-flex;padding:.25rem .6rem;border-radius:999px;background:var(--u-soft);color:#356b9d;font-size:.8rem;font-weight:600}
...
<div><h1 class="h5 mb-1">รายการค่าใช้จ่ายของโรงพยาบาล</h1><div class="small text-muted">กำหนดชื่อ หมวด วิธีคำนวณ และหน่วยนับให้ตรงกับระเบียบของแต่ละแห่ง</div></div>
...
<td><strong><?=Html::encode($model->name)?></strong><div class="small text-muted"><?=Html::encode($model->code)?></div></td>
...
<?php else:?><div class="text-center py-5"><div class="fw-semibold">ยังไม่มีประเภทค่าใช้จ่าย</div><div class="small text-muted mt-1">เพิ่มรายการแรกเพื่อเริ่มลงค่าใช้จ่ายรายเดือน</div></div><?php endif;?>
</div></div>
