...
final class Invoice extends HousingActiveRecord
{
    ...
    public function getMonthlyAccount(): ActiveQuery { return $this->hasOne(MonthlyAccount::class,['id'=>'monthly_account_id']); }
    public function getAllocations(): ActiveQuery { return $this->hasMany(PaymentAllocation::class,['invoice_id'=>'id']); }
}
