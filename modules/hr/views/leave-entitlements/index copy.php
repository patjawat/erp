        ...
        <table class="table table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="fw-semibold">ยอดยกมา</th>
                    <th scope="col" class="text-center fw-semibold">สิทธิสะสมวันลา</th>
                    <th scope="col" class="text-center fw-semibold">สมวันลาได้สูงสุด</th>
                    <th scope="col" class="text-center fw-semibold">สิทที่ลาได้ในปีนี้</th>
            ...
            <tbody class="align-middle table-group-divider">
                <?php foreach ($dataProvider->getModels() as $key => $item): ?>
                    <tr class="">
                        ...
                        <td class="text-center fw-semibold"></td>
                        <td class="text-center fw-semibold"></td>
                        <td class="text-center fw-semibold"><?php echo $item->policies?->max_days ?? ''; ?></td>
                        <td class="text-center fw-semibold"><?php echo $item->lastBalanceDays(); ?></td>
                        <td class="text-center fw-semibold"><?php echo $item->lastBalanceDays(); ?></td>
                        <td class="text-center fw-semibold"></td>
