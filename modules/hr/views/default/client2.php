<div class="row">
            <div class="col-12">
                ...
                <div class="card rounded-4">
                    ...
                    <div class="card-body">
                        <div class="card-title">ไกล้เกษียณอายุราชการ</div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown"> <a href="javascript:void(0);"
                                                    class="btn btn-outline-light btn-sm" data-bs-toggle="dropdown"
                                        ...
                                        <td class="border-bottom-0">
                                            <div class="dropdown"> <a href="javascript:void(0);"
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li><a class="dropdown-item" href="javascript:void(0);">In
                                                            Active</a></li>
                                                </ul>
                                            </div>
                                        </td>
