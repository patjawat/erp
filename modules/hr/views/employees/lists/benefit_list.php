...
<div class="card border-0">
    <div class="card-body">
        <div class="d-flex justify-content-between">
            <h5 class="card-title"><i class="fa-solid fa-heart-circle-plus"></i> <?=$this->title?></h5>
            <?=Html::a('<i class="fa-solid fa-circle-plus"></i> สร้างใหม่', ['/hr/employee-detail/create', 'emp_id' => $model->id, 'name' => 'blame', 'title' => '<i class="fa-solid fa-heart-circle-plus"></i> '.$this->title], ['class' => 'btn btn-primary rounded-pill shadow open-modal', 'data' => ['size' => 'modal-lg']])?>
        </div>
                        ...
                        <td class="text-center align-middle">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <??>
                                    <?=Html::a('<i class="fa-regular fa-pen-to-square me-1"></i>แก้ไข', ['/hr/employee-detail/update', 'id' => $item->id, 'title' => '<i class="fa-solid fa-heart-circle-plus"></i> '.$this->title], ['class' => 'dropdown-item open-modal', 'data' => ['size' => 'modal-lg']])?>
