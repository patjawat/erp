...
$title = '<i class="fa-solid fa-person-walking-luggage"></i> สัมมนา ฝึกอบรม ดูงาน ศึกษาต่อ';
?>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="margin-bottom: 100px;">
                ...
                <tbody>
                    <?php foreach ($model->develop as $key => $item): ?>
                    <tr class="">
                      <td><?=$key+1?></td>
                        <td>
                        ...
                        <td class="text-center align-middle">
                            <?php // $this->render('./actions',['model' => $item,'name' => $name,'title' => $title])?>
                        </td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
