    ...
    <div class="card-body">
        <div class="d-flex justify-content-between">
            ...
            <div class="btn-group dropup">
                <?=Html::a('<i class="fa-solid fa-circle-plus"></i> สร้างใหม่', ['/hr/employee-detail/create', 'emp_id' => $model->id, 'name' => 'position_manage', 'title' => '<i class="fa-solid fa-user-tag"></i> ปฏิบัติหน้าที่/ราชการตำแหน่งบริหาร'], ['class' => 'btn btn-primary rounded-start-pill shadow open-modal', 'data' => ['size' => 'modal-lg']])?>
