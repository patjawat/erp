...
<?php if($status == true): ?>
    ...
    <div class="col-6">
        ...
        <div class="alert alert-<?=$status == true ? 'success' : 'danger'?>" role="alert">
            ...
            <?php echo Html::a('<i class="fa-regular fa-thumbs-up"></i> ดำเนินการสำเร็จ !',['/hr/employees/'],['class' => $status == true ? 'btn btn-success' : 'btn btn-danger' ])?>
        </div>
...
<?php if($status == false): ?>
    ...
    <div class="col-6">
        ...
        <div class="alert alert-<?=$status == true ? 'success' : 'danger'?>" role="alert">
            ...
            <?php echo Html::a('<i class="fa-solid fa-rotate-left"></i> ย้อนกลับ !',['/hr/employees/import-csv'],['class' => $status == true ? 'btn btn-success' : 'btn btn-danger' ])?>
        </div>
    </div>
</div>
<?php endif;?>
