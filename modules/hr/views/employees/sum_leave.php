...
/* .avatar {
    ...
    font-weight: 500;
        ...
        <div class="d-flex justify-content-between">
            <div class="card-title">สิทธิการลา</div> <button type="button" class="btn btn-sm btn-light">เพิ่มเติม</button>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="p-2 w-100">
                ...
                <div class="progress progress-animate progress-xs" role="progressbar" aria-valuenow="10"
                    aria-valuemin="0" aria-valuemax="100">
                    <div class="progress-bar progress-bar-striped bg-primary" style="width: 10%"></div>
                </div>
            </div>
        </div>
