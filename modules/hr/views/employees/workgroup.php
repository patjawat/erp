<div class="card">
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div class="flex-grow-1 overflow-hidden">
                        ...
                        <p class="text-muted mb-3"><?=isset($model->getLeaderFormWorkGroup()->fullname) ? $model->getLeaderFormWorkGroup()->fullname : '-'?> <label class="badge rounded-pill text-primary-emphasis bg-success-subtle me-1"><i class="fa-solid fa-flag-checkered"></i> ผู้นำทีม</label></p>
                        ...
                        <div class="avatar-stack">
                            ...
                            ?>
                            <?php if($total >  11):?>
                                <a href="javascript: void(0);" class="condense-profile" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-title="ProfileUser">
                        ...
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item">
                                <h5 class="fs-14 mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                    ...
                                    <span class="align-middle"> จำนวสมาชิก <?=count($model->EmpOnWorkGroup($model->code))?> คน</span>
                                </h5>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="dropdown edit-field-half-left">
                <div class="btn-icon btn-icon-sm btn-icon-soft-primary me-0 edit-field-icon"
