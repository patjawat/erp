...
<div class="employees-form p-3">
    ...
    <input type="file" id="my_file" style="display: none;" />
            ...
            <a href="#" class="select-photo">
                ...
                <?=Html::img('@web/img/placeholder_cid.png',['class' => 'avatar-profile object-fit-cover rounded shadow','style' =>'margin-top: 25px;max-width: 135px;max-height: 135px;'])?>
                <?php else:?>
                    
                    <?=Html::img($model->showAvatar(),['class' => 'avatar-profile object-fit-cover rounded shadow','style' =>'margin-top: 25px;max-width: 135px;max-height: 135px;'])?>
           <?php endif?>
            </a>
   ...
   <div class="row">
   <div class="col-6">
    <?= $form->field($model, 'data_json[position_name]')->textInput()->label('ชื่อตำแหน่ง') ?>
</div>
<div class="col-6">
    <?= $form->field($model, 'data_json[position_number]')->textInput()->label('เลขประจำตำแหน่ง') ?>
    
</div>
<div class="col-6">
    <?= $form->field($model, 'data_json[position_type]')->widget(Select2::classname(), [
...
<!-- <div class="col-6">
    <?php //  $form->field($model, 'data_json[position_type4]')->textInput()->label('ตำแหน่งบริหาร') ?>
    
</div>
<div class="col-6">
    <?php //  $form->field($model, 'data_json[position_type5]')->textInput()->label('ความเชี่ยวชาญ') ?>
</div> -->

<div class="col-6">
    <?= $form->field($model, 'data_json[salary]')->textInput()->label('อัตราเงินเดือน') ?>
</div>
<div class="col-6">
    <?= $form->field($model, 'data_json[point]')->textInput(['placeholder' => '0.00'])->label('ผลการประเมิน') ?>
</div>
<div class="col-6">
