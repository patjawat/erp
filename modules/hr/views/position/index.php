            ...
            [
                ...
                'value' => function($model){
                        ...
                        <div class="dropdown-menu" style="">
                            <??>
                            '.Html::a('<i class="bx bx-edit-alt me-1"></i>แก้ไข', ['/hr/position/update', 'id' => $model->id, 'title' => '<i class="fa-regular fa-pen-to-square"></i> แก้ไขกลุ่ม'], ['class' => 'dropdown-item open-modal', 'data' => ['size' => 'modal-md']]).'
