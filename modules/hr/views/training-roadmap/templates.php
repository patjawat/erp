...
$this->beginBlock('page-action'); echo $this->render('@app/modules/hr/menu', ['active' => 'setting']); $this->endBlock();
...
<div class="trm-shell">
    ...
    <div class="trm-card">
        <form class="trm-toolbar" action="<?= Url::to(['templates']) ?>" method="get" data-pjax="1">
