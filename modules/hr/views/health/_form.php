        ...
        <div class="card shadow-sm border-0 mx-auto" style="max-width: 900px; border-radius: 20px;">
            <div class="card-body p-4 p-md-5 bg-white" style="border-radius: 20px;">
                ...
                <div class="step-content active" data-step="1">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6"><?= $form->field($model, 'emp_id')->textInput(['readonly' => true, 'class' => 'form-control bg-light'])->label('รหัสบุคลากร (Staff ID)') ?></div>
                ...
                <div class="step-content" data-step="3">
                    <h5 class="mb-4 d-flex align-items-center"><i class="fas fa-notes-medical text-danger me-2"></i> หมวดที่ 1: ประวัติโรคประจำตัว</h5>
                    <div class="row g-3">
                        <?php
                ...
                <div class="step-content" data-step="5">
                    ...
                    ?>
                        <div class="mb-4 habit-group">
                            <label class="text-slate-700 mb-3 d-block fw-bold"><?= $h['label'] ?></label>
