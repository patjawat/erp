            ...
            <div class="card-body p-4 p-md-5">
                <div class="row g-4">
                    ...
                    $listDocumentData = ArrayHelper::map($listDocumentMe, 'id', function($model) {
                        ...
                        ?>
                        <!-- <label class="form-label text-uppercase fw-bold text-muted small" style="font-size: 11px;">หนังสืออ้างอิง</label>
        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
            ...
            <div class="card-body p-4 p-md-5 d-flex flex-column gap-4">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <!-- <label class="form-label text-uppercase fw-bold text-muted small" style="font-size: 11px;">การเบิกเงิน</label>
                        <select class="form-select bg-light border-0 rounded-3 py-2 fw-bold">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <label class="form-label text-uppercase fw-bold text-muted small" style="font-size: 11px;">ระดับการพัฒนา</label>
                        <select class="form-select bg-light border-0 rounded-3 py-2 fw-bold">
                ...
                <div class="p-4 rounded-4 bg-info bg-opacity-10 border border-info border-opacity-10">
                    <div class="row g-4">
                        <div class="col-md-4">
                            <label class="d-flex align-items-center gap-1 text-info text-uppercase fw-bold small mb-2" style="font-size: 11px;">
                            ...
                            <div class="bg-white p-3 rounded-4 d-flex align-items-center gap-3 shadow-sm">
                                ...
                                <div class="overflow-hidden">
                                    <p class="m-0 fw-black text-truncate small">นางสุวสิณี สายบุญตง</p>
            ...
            <div class="card-body p-4 p-md-5">
                <div class="row g-5">
                    <div class="col-md-6 d-flex flex-column gap-4">
                        <div>
                            <label class="form-label text-uppercase fw-bold text-muted small" style="font-size: 11px;">สถานที่จัดงาน</label>
                            <input class="form-control bg-light border-0 rounded-3 py-2 fw-bold" type="text" value="โรงแรมอุ่นรักริมโขง อ.เชียงคาน จ.เลย">
                        </div>
                        <div class="row g-3">
                            <div class="col-6">
                                <label class="form-label text-uppercase fw-bold text-muted small" style="font-size: 11px;">จังหวัด</label>
                                <select class="form-select bg-light border-0 rounded-3 py-2 fw-bold">
                                    <option>เลย</option>
                                </select>
                            </div>
                            <div class="col-6">
                                <label class="form-label text-uppercase fw-bold text-muted small" style="font-size: 11px;">ประเภทสถานที่</label>
                                <div class="d-flex align-items-center gap-3 pt-2">
                                    <div class="form-check small fw-bold">
                                        <input class="form-check-input" type="radio" checked name="locType"> ในจังหวัด
                                    </div>
                                    <div class="form-check small fw-bold">
                                        <input class="form-check-input" type="radio" name="locType"> ต่างจังหวัด
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 bg-light bg-opacity-50 rounded-4 p-4 d-flex flex-column gap-4">
                        <div class="row g-3">
                            <div class="col-6">
                                <label class="form-label text-uppercase fw-bold text-muted small" style="font-size: 11px;">วัน-เวลาเดินทางไป</label>
                                <div class="d-flex gap-2">
                                    <input class="form-control form-control-sm border-0 fw-bold" type="date" value="2025-12-24">
                                    <input class="form-control form-control-sm border-0 fw-bold" type="time" style="width: 80px;" value="06:30">
                                </div>
                            </div>
                        </div>
                        <div class="row g-3">
                            <div class="col-6">
                                <label class="form-label text-uppercase fw-bold text-muted small" style="font-size: 11px;">พาหนะเดินทาง</label>
                                <select class="form-select border-0 fw-bold">
                                    <option>รถยนต์ราชการ</option>
                                </select>
                            </div>
                            <div class="col-6">
                                <label class="form-label text-uppercase fw-bold text-muted small" style="font-size: 11px;">ทะเบียนรถ</label>
            ...
            <div class="card-body p-4 d-flex flex-column gap-3 overflow-auto" style="max-height: 300px;">
                <div class="d-flex align-items-center gap-3 p-3 bg-light rounded-4 border border-transparent hover-border-primary transition-all group">
                    ...
                    <div class="flex-grow-1 overflow-hidden">
                        <input class="form-control-plaintext p-0 fw-bold text-dark small" style="font-size: 14px;" value="นางสุวสิณี สายบุญตง">
                ...
                <div class="d-flex flex-column gap-2 overflow-auto" style="max-height: 350px;">
                    <div class="p-3 bg-light rounded-4 border border-light">
                        <div class="d-flex justify-content-between mb-2">
                            <input class="form-control-plaintext p-0 fw-black text-dark small" value="ค่าลงทะเบียน">
