...
// สมมติว่า URL ของไฟล์ PDF เก็บอยู่ใน attribute ชื่อ pdf_path หรือ file_url 
// ให้เปลี่ยนเป็น attribute จริงที่คุณใช้ใน Model
...
<div class="row">
    ...
    <div class="col-md-3 sidebar-panel">
        ...
        <div id="fields-list">
            ...
            <div class="card field-card shadow-sm" data-field="company_name" data-title="ชื่อส่วนราชการ">
                <div class="card-body p-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center gap-2">
                        ...
                        ])->textInput(['class' => 'form-control form-control-sm coord-x'])->label(false) ?>

                        <?= $form->field($model, 'data_json[company_name_y]', [
                            'addon' => ['prepend' => ['content' => 'Y']]
                        ])->textInput(['class' => 'form-control form-control-sm coord-y'])->label(false) ?>
                    </div>
                </div>
            </div>
            ...
            <div class="card field-card shadow-sm" data-field="position" data-title="นักวิชาการคอมพิวเตอร์">
                <div class="card-body p-2">
                    <div class="small fw-bold mb-2 text-primary">ชื่อตำแหน่ง</div>
                    <div class="d-flex justify-content-between align-items-center gap-2">
...
$js = <<<JS
    ...
    // ฟังก์ชันสำหรับโหลด PDF จาก URL (ใช้สำหรับไฟล์ที่มีอยู่แล้วใน model)
    ...
    // ฟังก์ชันกลางในการวาด PDF ลง Canvas
    ...
    function initLabels() {
        ...
        $('.field-card').each(function() {
            ...
            let x = $(this).find('.coord-x').val() || 50;
            let y = $(this).find('.coord-y').val() || 50;
