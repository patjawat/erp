...
class DevelopmentSearch extends Development
{
    ...
    public function rules()
    {
        return [
            ...
            [['response_status','development_type_id','topic', 'status', 'date_start', 'time_start', 'date_end', 'time_end', 'vehicle_type_id', 'vehicle_date_start', 'vehicle_date_end', 'driver_id', 'leader_id', 'leader_group_id', 'emp_id', 'data_json', 'created_at', 'updated_at', 'deleted_at','q','q_department','date_filter','q_status'], 'safe'],
        ];
    }
