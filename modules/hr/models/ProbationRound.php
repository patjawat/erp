...
class ProbationRound extends ProbationActiveRecord
{
    ...
    public static function statusOptions() { return ['scheduled' => 'ยังไม่เปิดรอบ', 'waiting_self' => 'รอประเมินตนเอง', 'waiting_supervisor' => 'รอหัวหน้างาน', 'waiting_group_head' => 'รอหัวหน้ากลุ่มงาน', 'waiting_decision' => 'รอสรุปผลการจ้าง', 'waiting_acknowledgement' => 'รอ ผอ.รับทราบ', 'completed' => 'เสร็จสิ้น']; }
    ...
    public function getAcknowledgement() { return $this->hasOne(ProbationAcknowledgement::class, ['round_id' => 'id']); }
}
