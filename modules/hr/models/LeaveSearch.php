...
class LeaveSearch extends Leave
{
    ...
    public function rules()
    {
        return [
            ...
            [['date_start_type','date_end_type','date_filter', 'on_holidays', 'leave_type_id', 'data_json', 'date_start', 'date_end', 'created_at', 'updated_at', 'deleted_at', 'emp_id', 'thai_year', 'status', 'q', 'q_department','export','work_shift_name'], 'safe'],
