...
<div class="d-flex align-items-center gap-2">
    ...
    <a href="<?= Url::to(['/hr/workforce/index']) ?>"
       aria-label="งาน HRD"
       class="btn <?= in_array($active, ['workforce', 'idp', 'training-roadmap', 'jd', 'appraisal', 'exit', 'talent'], true) ? 'btn-primary' : 'btn-outline-primary' ?> d-inline-flex align-items-center gap-2"
       data-pjax="0">
