        ...
        <div class="card">
            <div class="card-header bg-primary-gradient text-white">
                <div class="d-flex justify-content-between">
                    ...
                    <?= Html::a('<i class="bi bi-plus-circle"></i> สร้างใหม่', ['/sm/product-type/create', 'title' => '<i class="bi bi-plus-circle text-primary"></i> สร้างใหม่'], ['class' => 'btn btn-success open-modal', 'data' => ['size' => 'modal-md']]) ?>
                </div>
            </div>
            <div class="card-body">
                <table class="table">
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><?= Html::a('<i class="bi bi-eye me-1"></i> แสดง', ['/sm/product-type/view', 'id' => $model->id], ['class' => 'dropdown-item open-modal', 'data' => ['size' => 'modal-md']]) ?></li>
                                            <li><?= Html::a('<i class="bi bi-pencil-square me-1"></i> แก้ไข', ['/sm/product-type/update', 'id' => $model->id, 'title' => '<i class="bi bi-pencil-square"></i> แก้ไข'], ['class' => 'dropdown-item open-modal', 'data' => ['size' => 'modal-md']]) ?></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
