...
<div class="d-flex gap-2  justify-content-center">
    <?=Html::a('<i class="bi bi-pencil-square me-1"></i>แก้ไข', ['/sm/asset-type/update', 'id' => $model->id, 'title' => '<i class="bi bi-pencil-square"></i> แก้ไข'], ['class' => 'btn btn-warning  open-modal', 'data' => ['size' => 'modal-lg']])?>
    <?=Html::a('<i class="bi bi-trash me-1"></i>ลบ', ['/sm/asset-type/delete', 'id' => $model->id], [
