...
<div class="d-flex gap-2  justify-content-center">
    <?=Html::a('<i class="bx bx-edit-alt me-1"></i>แก้ไข', ['/sm/asset-item/update', 'id' => $model->id, 'title' => '<i class="fa-regular fa-pen-to-square"></i> แก้ไข'], ['class' => 'btn btn-warning  open-modal', 'data' => ['size' => 'modal-lg']])?>
    <?=Html::a('<i class="bx bx-trash me-1"></i>ลบ', ['/sm/asset-item/delete', 'id' => $model->id], [
