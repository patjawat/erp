...
<body>
    ...
    <div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">หมวด ครุภัณฑ์</h3>
								
							</div>
							<div class="col-auto float-end ms-auto">
								<a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_object"><i class="fa fa-plus"></i> Add New </a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
								...
								<table class="table table-striped custom-table mb-0 datatable">
									...
									<tbody>
										<tr>
											<td>1</td>
											<td>6515-005-0003</td>
                                            <td>เครื่องกดนับแยกชนิดเม็ดเลือดขาว</td>
											<td>ครุภัณฑ์วิทยาศาสตร์การแพทย์</td>						
											<td>เครื่องกดนับแยกชนิดเม็ดเลือดขาว</td>
											<td>
											...
											<td class="text-end">
												<div class="dropdown dropdown-action">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit_object"><i class="fa fa-pencil m-r-5"></i> Edit</a>
														<a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_object"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
													</div>
												</div>
											</td>
										</tr>
										...
										<tr>
											<td>2</td>
											<td>6650-002-5102</td>
                                            <td>เครื่องวัดความดันตาชนิดสัมผัสกระจกตาชนิดมือถือระบบดิจิตอล</td>
											<td>ครุภัณฑ์วิทยาศาสตร์การแพทย์</td>											
											<td>เครื่องวัดความดันตาชนิดสัมผัสกระจกตาชนิดมือถือระบบดิจิตอล ความเร็วสูง</td>
											<td>
												<div class="dropdown action-label">
													<a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">
														<i class="fa fa-dot-circle-o text-success"></i> Active
				...
				<!-- /Page Content -->
						...
						<!-- Add  Modal -->
						<div class="modal custom-modal fade" id="add_object" role="dialog">
					<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">เพิ่ม หมวดครุภัณฑ์</h5>
				...
				<!-- Edit  Modal -->
				<div class="modal custom-modal fade" id="edit_object" role="dialog">
				<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">แก้ไข หมวดครุภัณฑ์</h5>
								<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>
				...
				<!-- Delete  Modal -->
				<div class="modal custom-modal fade" id="delete_object" role="dialog">
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							<div class="modal-body">
								<div class="form-header">
									<h3>ลบข้อมูลครุภัณฑ์</h3>
									<p>ท่านแน่ใจที่จะลบข้อมูลครุภัณฑ์ ?</p>
								</div>
