...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-12">
        <?=$form->field($model, 'data_json[date_begin]')->widget(Datetimepicker::className(),[
                                        'options' => [
                                            'timepicker' => false,
                                            'datepicker' => true,
                                            'mask' => '99/99/9999',
...
<?=$form->field($model, 'data_json[emp_type]')->textInput(['maxlength' => true])->label('ประเภทบุคลากร') ?>
...
$js = <<<JS
 ...
 $('#form-position').on('beforeSubmit', function (e) {
    ...
    $("#categorise-data_json-date_begin").datetimepicker({
        timepicker:false,
