...
<div class="row">
    <div class="col-lg-3">
        <?=$form->field($model, 'data_json[father]')->textInput(['maxlength' => true])->label('ชื่อบิดา')?>

    </div>
    <div class="col-lg-2">
        <?=$form->field($model, 'data_json[father_birthday]')->textInput(['maxlength' => true])->label('วันเกิด')?>

    </div>
    <div class="col-lg-4">
        <?=$form->field($model, 'data_json[father_cid]')->textInput(['maxlength' => true])->label('เลขที่บัตรประชาชน')?>

    </div>
    <div class="col-lg-3">
        <?=$form->field($model, 'data_json[father_comment]')->textInput(['maxlength' => true])->label('หมายเหตุ')?>
    ...
    <div class="row">
    <div class="col-lg-3">
        <?=$form->field($model, 'data_json[mother]')->textInput(['maxlength' => true])->label('ชื่อมารดา')?>

    </div>
    <div class="col-lg-2">
        <?=$form->field($model, 'data_json[mother_birthday]')->textInput(['maxlength' => true])->label('วันเกิด')?>

    </div>
    <div class="col-lg-4">
        <?=$form->field($model, 'data_json[mother_cid]')->textInput(['maxlength' => true])->label('เลขที่บัตรประชาชน')?>

    </div>
    <div class="col-lg-3">
        <?=$form->field($model, 'data_json[mother_comment]')->textInput(['maxlength' => true])->label('หมายเหตุ')?>
