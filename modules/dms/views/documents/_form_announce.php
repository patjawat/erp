...
<?= $form->field($model, 'document_type')->hiddenInput(['maxlength' => 50])->label(false); ?>
<?= $form->field($model, 'doc_number')->hiddenInput(['value' => '-'])->label(false); ?>
<?= $form->field($model, 'secret')->hiddenInput(['value' => 'ปกติ'])->label(false); ?>
<?= $form->field($model, 'doc_speed')->hiddenInput(['value' => 'ปกติ'])->label(false); ?>
<?= $form->field($model, 'document_org')->hiddenInput(['value' => '0'])->label(false); ?>
<div class="card">
    <div class="card-body">
...
<div class="col-6">
    ...
    <?php
            echo $form->field($model, 'data_json[document_type_sub]')->widget(Select2::classname(), [
                'data' => [
                    'ประกาศ' => 'ประกาศ',
                    'นโยบาย' => 'นโยบาย',
                ],
...
<div class="col-6">
    <?php //  $form->field($model, 'doc_number')->textInput(['maxlength' => true]) ?>
</div>
<div class="col-6">
    <?php  // echo $form->field($model, 'doc_date')->textInput(['placeholder' => 'เลือกวันที่หนังสือ'])->label('วันที่หนังสือ') ?>
</div>
<div class="col-6">
...
<div class="col-6">
    <div class="d-flex gap-2">
        ...
        <?php //  $form->field($model, 'doc_time')->widget(\yii\widgets\MaskedInput::className(), ['mask' => '99:99']) ?>
