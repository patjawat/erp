...
<body>
    ...
    <main role="main">
        ...
        <div class="page-wrapper"  id="page-content">
            <?php  echo $this->render('@app/themes/v3/layouts/theme-v/header'); ?>
            ...
            <div class="main-content">
                <div class="page-content">
                    <?php  echo $this->render('@app/themes/v3/layouts/theme-v/page_title'); ?>
                    <div class="page-content-wrapper mt--45">
                        <div>
                            <?php echo $this->render('@app/themes/v3/layouts/theme-v/content', ['content' => $content]); ?>
                        </div>
