...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-primary-gradient text-white py-2 d-flex justify-content-between align-items-center">
        <h6 class="mb-0 text-white small fw-normal">
            <i class="fas fa-heartbeat me-1"></i> รายการโรคประจำตัว
                ...
                <tbody class="align-middle table-group-divider">
                    ...
                    <?php foreach ($models as $i => $model): ?>
                        <tr>
                            ...
                            <td>
                                <code class="badge bg-danger bg-opacity-10 text-danger border border-danger-subtle rounded-pill fw-medium px-2 py-1">
