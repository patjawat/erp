...
$this->params['breadcrumbs'][] = ['label' => $typeLabel, 'url' => ['/development/setting/template', 'code' => $code]];
...
<div class="alert alert-info border-0 rounded-3 mb-3 d-flex align-items-start gap-2" role="status">
    ...
    <div class="small">
        <strong>การพิมพ์ใบขอไปราชการ</strong> — หลังบันทึกตำแหน่งแล้ว ไปที่รายการขอไปราชการ แล้วกดปุ่ม «พิมพ์» ที่รายการที่ต้องการ เพื่อเปิดหน้ารูปแบบพิมพ์
    </div>
</div>
            ...
            <div class="col-12 col-lg-4">
                ...
                <form id="positions-form">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <?= Html::a('ย้อนกลับ', ['/development/setting/template'], ['class' => 'btn btn-outline-secondary rounded-3']) ?>
                    </div>
                </form>
            </div>
...
$saveUrl = Url::to(['/development/setting/save-positions', 'code' => $effectiveCode]);
