...
$typeLabel = 'Template กลาง (Default)';

$this->title = 'แบบฟอร์มไปราชการ — ' . $typeLabel;
...
$this->params['breadcrumbs'][] = ['label' => 'Template', 'url' => ['/development/setting/template']];
$this->params['breadcrumbs'][] = $typeLabel;

$uploadActionUrl = Url::to(['/development/setting/upload-template', 'code' => $code]);
...
<div class="card border-0 shadow-sm rounded-3 overflow-hidden">
    <div class="card-header bg-primary bg-opacity-10 text-primary border-0 py-2 px-4 d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div class="d-flex align-items-center gap-2">
            <?= Html::a('<i class="bi bi-arrow-left me-1"></i> รายการ', ['/development/setting/template'], ['class' => 'btn btn-outline-secondary btn-sm rounded-3']) ?>
        ...
        <div class="d-flex gap-2 align-items-center">
            <?= Html::a(
                ...
                ['/development/setting/positions', 'code' => $code],
                ['class' => 'btn btn-primary btn-sm rounded-3 fw-medium']
            ) ?>
            <?= Html::a(
                '<i class="bi bi-list-ul me-1"></i> รายการขอไปราชการ',
                ['/development/default/dashboard'],
        ...
        <div class="col-12 col-md-3 border-end p-3">
            <div class="lt-sidebar">
                ...
                <div class="rounded-3 bg-primary bg-opacity-10 p-2">
                    <p class="small text-primary fw-semibold mb-1" style="font-size:.75rem;"><i class="bi bi-lightbulb me-1"></i> เทมเพลตใบขอไปราชการ</p>
                    <ol class="text-muted mb-0 ps-3" style="font-size:.72rem;">
                        ...
                        <li>ใช้เทมเพลตนี้เมื่อพิมพ์ใบขอไปราชการ</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 col-lg-5">
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted small mb-0">สำหรับ <strong>ใบขอไปราชการ</strong></p>
                </div>
