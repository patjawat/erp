...
<div class="development-list development-list-modern">
    ...
    $form = ActiveForm::begin([
        ...
        'options' => ['class' => 'development-list-filter-form mb-4', 'id' => 'development-mine-filter-form'],
        'fieldConfig' => [
            'options' => ['class' => 'mb-0'],
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mt-3 mb-3">
        ...
        <div class="d-flex align-items-center gap-2">
            <?= Html::a('<i class="bi bi-plus-circle me-1"></i> สร้างใหม่', ['/development/travel-request/index', 'thai_year' => $thaiYear], ['class' => 'btn btn-primary btn-sm rounded-pill']) ?>
            <?php
            $exportParams = [
                'thai_year' => $thaiYear,
                'DevelopmentSearch' => [
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownYearMine">
                    ...
                    <li><a class="dropdown-item" href="<?= Url::to(['/development/default/mine', 'thai_year' => $y]) ?>">ปี <?= (int) $y ?></a></li>
                    <?php endforeach; ?>
                </ul>
            </div>
        </div>
