...
<div class="card text-start">
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between  align-top align-items-center mt-4">
                ...
                <?= Html::a('<i data-lucide="circle-plus"></i> ขอลา', ['/me/leave/create','title' => '<i class="fa-solid fa-calendar-plus"></i> บันทึกขออนุมัติการลา'], ['class' => 'btn btn-primary rounded-pill shadow open-modal','data' => ['size' => 'modal-lg']]) ?>
        </div>
