...
<h1 class="text-center"><i class="fa-regular fa-circle-check"></i> เห็นชอบ</h1>
<?php endif;?>

<?php if($model->status == 'Reject'):?>
<h1 class="text-center"><i class="fa-solid fa-xmark"></i> ไม่เห็นชอบ</h1>
<?php endif;?>

<h1 class="load text-center" style="display:none"><i class="fas fa-cog fa-spin"></i> กำลังดำเนินการ</h1>
