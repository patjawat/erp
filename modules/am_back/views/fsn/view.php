...
<div class="d-flex gap-2  justify-content-center">
    <?=Html::a('<i class="fa-regular fa-pen-to-square me-1"></i>แก้ไข', ['/am/fsn/update', 'id' => $model->id, 'title' => '<i class="fa-regular fa-pen-to-square"></i> แก้ไข'], ['class' => 'btn btn-warning  open-modal', 'data' => ['size' => 'modal-md']])?>
    <?=Html::a('<i class="fa-solid fa-trash me-1"></i>ลบ', ['/am/fsn/delete', 'id' => $model->id], [
