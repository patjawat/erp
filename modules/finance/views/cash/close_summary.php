...
<div class="card border"><div class="card-body table-responsive">
    <table class="table table-hover align-middle">
        <thead class="table-light"><tr>
            ...
            <th class="text-end">จำนวนจ่าย</th><th class="text-end">ยอดจ่าย</th><th class="text-end">คงเหลือ</th><th>ปิดเมื่อ</th>
        </tr></thead>
        <tbody>
            ...
            <?php endforeach; ?>
            <?php if (!$batches): ?><tr><td colspan="7" class="text-center text-body-secondary py-5">ยังไม่มีการปิดบัญชีในปีงบนี้</td></tr><?php endif; ?>
        </tbody>
        <?php if ($batches): ?>
        <tfoot><tr class="table-light fw-bold">
            ...
            <td class="text-end"><?= number_format($totIn - $totOut, 2) ?></td><td></td>
        </tr></tfoot>
        <?php endif; ?>
    </table>
</div></div>
