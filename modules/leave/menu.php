...
<div class="d-flex gap-2">
    <a href="<?= Url::to(['/leave/leave/dashboard']) ?>" class="btn <?= $active !== 'dashboard' ? 'btn-outline-primary' : 'btn-primary' ?>">
        <i data-lucide="layout-grid"></i>
        ภาพรวม
    </a>
    <a href="<?= Url::to(['/leave/leave/index']) ?>" class="btn <?= $active !== 'list' ? 'btn-outline-primary' : 'btn-primary' ?>">
    ...
    <a href="<?= Url::to(['/leave/leave/report']) ?>" class="btn <?= $active !== 'report' ? 'btn-outline-primary' : 'btn-primary' ?>">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            ...
            <li>
                <?= Html::a('<i class="fa-solid fa-caret-right  me-1"></i> ประเภทการลา', ['/leave/leave-type'], ['class' => 'dropdown-item']) ?>
            </li>
            <li>
                <?= Html::a('<i class="fa-solid fa-caret-right  me-1"></i> นโยบายการลา', ['/leave/leave-policies'], ['class' => 'dropdown-item']) ?>
            </li>
            <li>
                <?= Html::a('<i class="fa-solid fa-caret-right  me-1"></i> กำหนดสิทธิลาพักผ่อน', ['/leave/leave-entitlements'], ['class' => 'dropdown-item']) ?>
            </li>
            <li>
                <?= Html::a('<i class="fa-solid fa-caret-right  me-1"></i> กำหนดเวร 8', ['/leave/work-shift'], ['class' => 'dropdown-item']) ?>
            </li>
            <li>
                <?= Html::a('<i class="fa-solid fa-caret-right  me-1"></i> วันหยุด', ['/leave/holiday'], ['class' => 'dropdown-item']) ?>
            </li>
