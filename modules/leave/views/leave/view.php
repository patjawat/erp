...
<div class="d-flex flex-wrap justify-content-center align-items-center gap-2 gap-md-3">
    <?= Html::a('<i class="bi bi-printer me-1"></i> พิมพ์ใบลา (PDF)', ['/leave/leave/pdf', 'id' => $model->id], ['class' => 'btn btn-outline-primary rounded-pill shadow', 'target' => '_blank', 'rel' => 'noopener noreferrer', 'data-pjax' => '0', 'title' => 'ใช้เทมเพลตจากการตั้งค่า PDF (/pdf-template); ถ้ายังไม่ตั้งจะใช้แบบฟอร์มใบลาเดิม — พิมพ์ได้ทุกสถานะ']) ?>
    <span class="small text-muted d-none d-md-inline">เทมเพลต PDF ตาม /pdf-template</span>
