...
#iframe-leave-pdf { width: 100%; min-height: 80vh; border: 0; border-radius: 0.5rem; }
</style>
...
<div class="container-fluid py-4 no-print">
    ...
    <p class="small text-muted mb-0">
        <?php if ($pdfUrl): ?>
        ใบลาด้านล่างสร้างจากเทมเพลตที่อัปโหลด — กดปุ่ม «พิมพ์ใบลา» หรือ Ctrl+P (Cmd+P) เพื่อพิมพ์
        <?php else: ?>
