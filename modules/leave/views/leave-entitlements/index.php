            ...
            <div class="d-flex gap-2">
                ...
                <?= Html::a('<i class="fa-solid fa-user-clock"></i> กำหนดสิทธิทั้งหมด', ['create-all', 'title' => 'กำหนดสิทธิลาพักผ่อนทั้งหมด'], ['class' => 'btn btn-warning create-all  rounded-pill shadow', 'data' => ['size' => 'modal-md']]) ?>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li><?= Html::a('<i class="fa-solid fa-file-csv me-2"></i>นำเข้าด้วย CSV', ['/leave/leave-entitlements/form-import', 'title' => '<i class="fas fa-file-csv text-white"></i> นำเข้าไฟล์ CSV'], ['class' => 'dropdown-item open-modal', 'data' => ['size' => 'modal-lg']]) ?></li>
...
<?php
$url = Url::to(['/leave/leave-entitlements/export']);
$createAllUrl = Url::to(['/leave/leave-entitlements/create-all']);
$js = <<< JS
