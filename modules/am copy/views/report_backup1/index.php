                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody class="table-group-divider">
                            ...
                            <tr>
                                <td>
                                    <?=Html::a('<i class="bi bi-check2-circle fs-5 me-1"></i><span class="fw-bolder">'.$model['title'].'</span>',['/am/asset/depreciation','id'=> $model['id']],['class' => 'text-truncate open-modal text-primary','data' => ['size' => 'modal-lg']])?>
                                    <br>
                                    <i class="bi bi-check2-circle fs-5 me-1"></i> <code>
                                        <?=$model['code']?>
                                ...
                                <td class="text-end align-middle"><?=number_format($model['month_price'],2)?></td>
                                <td></td>
                                <td></td>
                                <td class="text-end align-middle fw-semibold"><?=number_format($model['total'],2)?></td>
                            </tr>
