                            ...
                            <table class="table text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><?=$model->Depreciation($searchModel->q_month,$searchModel->q_year)['last_price']?></td>
                                        <td align="right"><?=$model->Depreciation($searchModel->q_month,$searchModel->q_year)['depreciation']?></td>
                                        <td align="right"><?=number_format($model->Depreciation($searchModel->q_month,$searchModel->q_year)['total_month_price'],2)?> </td>
                                        <td align="right"><?=number_format($model->Depreciation($searchModel->q_month,$searchModel->q_year)['total'],2)?> </td>
                                    </tr>
