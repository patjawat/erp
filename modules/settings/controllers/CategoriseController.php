            ...
            if($this->request->isAjax){
                Yii::$app->response->format = Response::FORMAT_JSON;
                    return [
                        ...
                        // return $this->redirect(['/settings/categorise/']);
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                ...
                return [
                    ...
                    'url' => Url::to(['/settings/categorise','name' => $model->name,'title' => $title])
                ];
            }
            }
        } else {
    ...
    public function actionDelete($id)
    {
        ...
        if($model->delete()){
            return [
                ...
                'url' => Url::to(['/settings/categorise/','name' => $model->name,'title' => ''])
            ];
        }
    }
