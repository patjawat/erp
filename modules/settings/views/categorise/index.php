            ...
            autocomplete="off">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td class="text-end">
                        <?=Html::a('ดำเนินการ',['/settings/categorise','name' => $item['name'],'title' => $item['title']],['class' => 'btn btn btn-sm btn-warning'])?>
                        </td>
                    </tr>
                    <?php endforeach;?>
...
<?=$this->render('@app/modules/settings/views/categorise/menu',['name' => $name,'title' => $title])?>
<?= GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            // 'headerOptions' => ['style' => 'width:100px'],
            'value' => function($model){
                return $this->render('@app/modules/settings/views/categorise/action',['model' => $model]);
            }
        ],
...
<div class="d-flex justify-content-center">
    <?= Html::a('<i class="bi bi-arrow-left-circle"></i> ย้อนกลับ', ['/settings/categorise'], ['class' => 'btn btn-primary shadow rounded-pill text-center']) ?>
</div>
