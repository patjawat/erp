...
<?= GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            // 'headerOptions' => ['style' => 'width:100px'],
            'value' => function($model){
                return Html::a('<i class="fa-solid fa-eye me-1"></i>', ['/settings/categorise/view', 'id' => $model->id, 'title' => '<i class="fa-regular fa-pen-to-square"></i> แก้ไข'], ['class' => 'open-modal', 'data' => ['size' => 'modal-md']]);
            }
        ],
