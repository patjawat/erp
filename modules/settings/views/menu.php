...
<li class="nav-item">
    <?=Html::a('<i class="bi bi-people-fill me-1"></i> ตั้งค่าบุคลากร',['/hr/categorise'],['class' => 'nav-link ' . (isset($active) && $active =='line' ? 'employee' : '')])?>
</li>
<li class="nav-item">
    <?=Html::a('<i class="bi bi-folder-check me-1"></i> ตั้งค่าประเภททรัพย์สิน',['/am/setting'],['class' => 'nav-link ' . (isset($active) && $active =='line' ? 'am-setting' : '')])?>
</li>
<?php endif;?>