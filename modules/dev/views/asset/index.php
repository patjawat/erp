        ...
        <div class="card-header bg-white border-bottom py-3 px-4" style="border-top-left-radius: 12px; border-top-right-radius: 12px;">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                ...
                <div class="bg-light p-1 rounded-3 d-flex gap-1">
                    ...
                    <button type="button" class="btn btn-sm text-secondary fw-medium d-flex align-items-center gap-2 px-3 py-2 border-0 rounded-3 tab-btn">
                    ...
                    <button type="button" class="btn btn-sm bg-white shadow-sm text-primary fw-bold d-flex align-items-center gap-2 px-3 py-2 border-0 rounded-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control border-start-0 ps-2 shadow-none text-secondary"

                               placeholder="ค้นหารหัส, ชื่อทรัพย์สิน..."

                               style="font-size: 0.9rem; width: 220px;">

                    </div>



                   <a href="<?= \yii\helpers\Url::to(['create']) ?>" class="btn btn-primary d-flex align-items-center gap-2 text-nowrap px-3 shadow-sm btn-sm" style="font-weight: 500;">
