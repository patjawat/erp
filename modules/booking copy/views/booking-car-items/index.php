...
<div class="card">
    ...
    <div class="d-flex justify-content-between">
            ...
            <?php echo html::a('<i class="fa-solid fa-plus"></i> เพิ่มข้อมูลขอใช้รถยนต์',['/booking/booking-car-items/create','title' => '<i class="fa-solid fa-plus"></i> เพิ่มข้อมูลรถยนต์'],['class' => 'btn btn-primary rounded-pill shadow open-modal','data' => ['size' => 'modal-lg']])?>
        </div>
