...
class Meeting extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['code', 'title', 'date_start', 'date_end', 'time_start', 'time_end', 'thai_year', 'urgent', 'status', 'emp_id'], 'required'],
            ...
            [['ref', 'code', 'title', 'time_start', 'time_end', 'urgent', 'status', 'emp_id'], 'string', 'max' => 255],
        ];
    }
