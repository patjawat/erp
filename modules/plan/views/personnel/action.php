...
<div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <?= (Yii::$app->user->can('planApprove') && $model->status == 'submit') ?  '<li>'.Html::a('<i class="fa-solid fa-circle-check me-2"></i> อนุมัติแผน', ['/plan/plan-order/approve', 'id' => $model->id], ['class' => 'btn btn-success open-modal dropdown-item', 'data' => ['size' => 'modal-m']]).'</li>' : '' ?>
                    <?= $model->status == 'approve' ?  '<li>'.Html::a('<i class="fa-solid fa-arrow-rotate-left me-2"></i> ปรับแผน', ['/plan/plan-order/renew'], ['class' => 'btn btn-warning dropdown-item renew', 'data' => ['id' => $model->id]]).'</li>' : '' ?>
