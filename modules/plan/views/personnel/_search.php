        ...
        <div class="row g-3 align-items-end">
            ...
            <div class="col-12 col-md-6 col-xl">
                        ...
                        echo $form->field($model, 'plan_category_id')->widget(Select2::classname(), [
                            'data' => ArrayHelper::map(Categorise::find()->where(['name' => 'plan_category', 'category_id' => 'PER'])->orderBy('sort')->all(), 'code', 'title'),
                            'options' => [
                                'placeholder' => 'ทุกรายการคำขอบุคลากร',
                            ],
                            'pluginOptions' => [
                                'allowClear' => true,
                            ],
                    ...
                    <div class="col-12 col-md-6 col-xl">
                        ...
                        echo $form->field($model, 'plan_item_id')->widget(Select2::classname(), [
                            'data' => ArrayHelper::map(Categorise::find()->where(['name' => 'plan_item'])->andWhere(['category_id' => array_column(Categorise::find()->select('code')->where(['name' => 'plan_category', 'category_id' => 'PER'])->asArray()->all(), 'code')])->orderBy('sort')->all(), 'code', 'title'),
                            'options' => [
                                'placeholder' => 'ทุกประเภทค่าใช้จ่าย',
                            ],
                            'pluginOptions' => [
                                'allowClear' => true,
                            ],
