...
/**
 * PlanOrderItemSearch represents the model behind the search form of `app\modules\plan\models\PlanOrderItem`.
 */
class PlanOrderItemSearch extends PlanOrderItem
{
    /**
     * {@inheritdoc}
     */
