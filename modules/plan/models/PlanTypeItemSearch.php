...
/**
 * PlanTypeItemSearch represents the model behind the search form of `app\modules\plan\models\PlanTypeItem`.
 */
class PlanTypeItemSearch extends PlanTypeItem
{
    /**
     * {@inheritdoc}
     */
