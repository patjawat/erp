...
/**
 * PlanBudgetTypeSearch represents the model behind the search form of `app\modules\planv2\models\PlanBudgetType`.
 */
class PlanBudgetTypeSearch extends PlanBudgetType
{
    /**
     * {@inheritdoc}
     */
