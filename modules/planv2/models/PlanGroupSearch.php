...
/**
 * PlanGroupSearch represents the model behind the search form of `app\modules\planv2\models\PlanGroup`.
 */
class PlanGroupSearch extends PlanGroup
{
    /**
     * {@inheritdoc}
     */
