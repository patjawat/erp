...
use app\modules\planv2\models\PlanType;

/**
 * PlanTypeSearch represents the model behind the search form of `app\modules\planv2\models\PlanType`.
 */
class PlanTypeSearch extends PlanType
{
    /**
     * {@inheritdoc}
     */
