    ...
    <?php if ($canManage): ?>
        <div class="card border-0 shadow-sm rounded-4 mb-3"><div class="card-body">
            ...
            <?= Html::beginForm(['open'], 'post', ['class' => 'row g-3 align-items-end']) ?>
                ...
                <div class="col-12 col-sm-2"><label class="form-label">ปี ค.ศ.</label><?= Html::input('number', 'count_year', date('Y'), ['class' => 'form-control', 'min' => 2000, 'max' => 2200, 'required' => true]) ?></div>
