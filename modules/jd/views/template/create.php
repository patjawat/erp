...
?>
<?php $this->beginBlock('page-title'); ?><div><h4 class="fw-semibold mb-1"><?= Html::encode($this->title) ?></h4><div class="text-muted small">กำหนดข้อมูลหลักก่อนเข้าสู่การจัดทำเนื้อหา 10 หมวด</div></div><?php $this->endBlock(); ?>
