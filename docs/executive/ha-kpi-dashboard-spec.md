...
| 3 | แผนยุทธศาสตร์ | `/pm/strategy-plan/index` | เดิม (ตัวชี้วัดยุทธศาสตร์เข้าผ่านปุ่ม "ทะเบียนตัวชี้วัด" ในหน้าแผน) |
| — | ~~ตัวชี้วัด~~ | — | **เอา pill ออก** (ซ้ำกับ "ทะเบียนตัวชี้วัด" ในหน้าแผน) |
| 4 | **KPI โรงพยาบาล** | `/pm/kpi/index` (ใหม่) | หัวข้อ "ตัวชี้วัดของโรงพยาบาล" (ไม่ใช้คำ "นอกแผน"); เพิ่ม/ลบ/แก้/จัดการ/แสดงผล |
