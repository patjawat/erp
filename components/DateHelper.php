...
class DateHelper extends Component
{
    ...
    //เพื่อแปลงจาก พุทธศักราช (BE) หรือ คริสต์ศักราช (AD) ให้เป็นรูปแบบมาตรฐานของ Database (YYYY-MM-DD)
    public static function convertToDatabaseDate($dateStr)
{
    if (empty($dateStr)) return null;

    // แยก ส่วนประกอบ วัน/เดือน/ปี (รองรับทั้ง / และ -)
    ...
    // ตรวจสอบว่าเป็นปี พ.ศ. หรือไม่ (ปกติ พ.ศ. จะ > 2400)
    if ($year > 2400) {
        $year = $year - 543;
    }
