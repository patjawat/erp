...
<?php $this->beginPage() ?>
<!DOCTYPE html>
<html lang="<?Yii::$app->language ?>" data-layout="vertical" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-layout-mode="purple" data-layout-width="fluid" data-layout-position="fixed" data-layout-style="default">
...
.select2-container--krajee-bs5 .select2-results__option--highlighted[aria-selected] {
    background-color: #b8c2ee !important;
    color: #405bd4 !important;
}
.btn-add-gradient {
    color: #e8e8e8;
    float: right;
