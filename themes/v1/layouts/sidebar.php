                ...
                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: 100%; height: 287px;"><div class="sidebar-inner slimscroll" style="overflow: hidden; width: 100%; height: 287px;">
					<div id="sidebar-menu" class="sidebar-menu">
							...
							<ul class="list-inline-item list-unstyled links">
								...
								<li class="submenu">
									...
									<ul style="display: none;">
										<li><a href="admin-dashboard.html">Dashboard ผู้ดูแลระบบ</a></li> 
										<!-- <li><a href="admin-dashboard.html">Admin Dashboard</a></li> -->
										<li><a href="employee-dashboard.html">Dashboard เจ้าหน้าที่</a></li>
								...
								<li class="submenu">
									...
									<ul style="display: none;">
										<li><a href="chat.html">ระบบจองรถ</a></li>
										<li><a href="<?=Url::to('shiftScheduling')?>">การจัดตารางเวลา</a></li>
										<li class="submenu">
								...
								<li class="submenu">
									<a href="#" class="noti-dot"><i class="la la-user"></i> <span> <?=Yii::t('app','employees')?></span> <span class="menu-arrow"></span></a>
									<ul style="display: none;">
										<li><?=Html::a('All Employees',['/employees'])?></li>
						...
						<ul class="sidebar-vertical">
							<?php if(Yii::$app->controller->module->id == 'settings'):?>
								<?=$this->render('menu_setting')?>
