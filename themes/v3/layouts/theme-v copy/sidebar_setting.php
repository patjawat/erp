    ...
    <div class="scroll-content" id="metismenu" data-scrollbar="true" tabindex="-1"
        ...
        <div class="scroll-content">
            ...
            <ul id="side-menu" class="metismenu list-unstyled">
                ...
                <li class="side-nav-title side-nav-item menu-title fs-6"><i class="fa-solid fa-gear"></i>
                    ตั้งค่าระบบหลัก</li>
                <li>
                ...
                <li class="side-nav-title side-nav-item menu-title  fs-6">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        class="lucide lucide-monitor-cog fs-4 me-2">
                        <path d="M12 17v4" />
                ...
                <!-- <li>
                    <a class="side-nav-link" href="<?= Url::to(['/settings/asset-items']) ?>">
