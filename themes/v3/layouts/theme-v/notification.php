...
<div class="d-inline-flex ms-0 ms-sm-2 dropdown"> 
    <button data-bs-toggle="dropdown" aria-haspopup="true" type="button" id="page-header-notification-dropdown"
        ...
        <span class="badge bg-danger badge-pill notify-icon-badge bg-danger rounded-pill text-white">
            <?php echo $notify['total'] ?>
        </span> 
    </button> 
            ...
            <div class="scroll-content container"> 
                <a href="<?php echo Url::to(['/me/approve', 'name' => 'leave']); ?>"> 
                    <div class="d-flex justify-content-between"> 
                        ...
                        <span class="badge bg-danger badge-pill bg-danger rounded-pill text-white">
                            <?php echo $leave['total'] ?>
                        </span> 
                    </div> 
                </a> 
            </div> 
