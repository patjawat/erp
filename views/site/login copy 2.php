...
<div class="login-page d-flex justify-content-center mt-5">



    <div class="card border-0 p-4" style="width: 500px;">
        <div class="card-body">
...
<div class="d-flex justify-content-center banner-container" >
    <div class="d-flex justify-content-around gap-4 banner" style="width:500px;">
        <?=Html::img('@web/banner/banner1.jpg',['style'=> 'width:120px'])?>
        <?=Html::img('@web/banner/banner2.png')?>
        <?=Html::img('@web/banner/banner3.png')?>
    </div>
</div>
...
<svg _ngcontent-ng-c105734841="" id="clouds" xmlns="http://www.w3.org/2000/svg" width="2611.084" height="485.677"
