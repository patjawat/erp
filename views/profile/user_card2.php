  ...
  <div class="container overflow-hidden">
    <div class="row gy-5 gy-lg-0 align-items-lg-center justify-content-lg-between">
      <div class="col-12 col-lg-6 order-1 order-lg-0">
        <h1 class="display-3 fw-bold mb-3">A Digital Agency Specialized in AI and Web 3.0</h1>
        ...
        <div class="d-grid gap-2 d-sm-flex">
          <button type="button" class="btn btn-primary bsb-btn-3xl rounded-pill">Explore Now</button>
          <button type="button" class="btn btn-outline-primary bsb-btn-3xl rounded-pill">Free Trial</button>
        </div>
      </div>
      <div class="col-12 col-lg-5 text-center">
        <div class="position-relative">
          ...
          <img class="img-fluid position-relative z-2" loading="lazy" src="https://bootstrapbrain.com/demo/components/heroes/hero-3/assets/img/hero-img-1.webp" alt="">
        </div>
      </div>
    </div>
  </div>
