...
<?php $form = ActiveForm::begin([
    ...
    'options' => [
        'enctype' => 'multipart/form-data'
                                    ...
                                    <div class="row">
                                         <div class="col-md-6">
                                                <?= $form->field($model, 'data_json[date_change]')->textInput(['maxlength' => true])->label('วันที่เปลี่ยน') ?>
                                         </div>
                                         <div class="col-md-6">
                                                <?= $form->field($model, 'data_json[prefix_change]')->textInput(['maxlength' => true])->label('คำนำหน้า') ?>
                                         </div>
                                    </div>

                                    <div class="row">
                                          <div class="col-md-6">
                                                <?= $form->field($model, 'data_json[name_change]')->textInput(['maxlength' => true])->label('ชื่อ') ?>
                                          </div>
                                          <div class="col-md-6">
                                                <?= $form->field($model, 'data_json[name_lastchange]')->textInput(['maxlength' => true])->label('นามสกุล') ?>
                                          </div>
                                    </div>

                                    <div class="row">
                                            <div class="col-md-6">
                                                    <?= $form->field($model, 'data_json[name_status]') ?>
                                            </div>
                                            <div class="">
                                                    <?= $form->field($model, 'data_json[name_transitionstatus]') ?>
                                            </div>
