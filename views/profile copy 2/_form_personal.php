...
<?php $form = ActiveForm::begin([
    ...
    'options' => [
        'enctype' => 'multipart/form-data'
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                        <?= $form->field($model, 'data_json[sex]')->textInput(['maxlength' => true])->label('เพศ') ?>
                                                </div>
                                                <div class="col-md-6">
                                                       <?= $form->field($model, 'data_json[birthday]')->textInput(['maxlength' => true])->label('วันเดือนปีเกิด') ?>
                                                </div>
                                            </div>

                                            <div class="row">
                                                <div class="col-md-6">
                                                       <?= $form->field($model, 'data_json[old]')->textInput(['maxlength' => true])->label('อายุ') ?>
                                                </div>
                                                <div class="col-md-6">
                                                    <?= $form->field($model, 'data_json[status]')->textInput(['maxlength' => true])->label('สถานภาพ') ?>
                                                </div>
                                            </div>
                                          
                                            <div class="row">
                                                <div class="col-md-6">
                                                   <?= $form->field($model, 'data_json[nationality]')->textInput(['maxlength' => true])->label('สัญชาติ') ?>
                                                </div>
                                                <div class="col-md-6">
                                                   <?= $form->field($model,'data_json[religion]')->textinput(['maxlength' => true])->label('ศาสนา') ?>
                                                </div>
                                            </div>
                              
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <?= $form->field($model, 'data_json[nationality]')->textinput(['maxlength' => true])->label('เชื้อชาติ') ?>
                                                </div>
                                                <div class="col-md-6">
                                                   <?= $form->field($model, 'data_json[blood_group]')->textinput(['maxlength' => true])->label('หมู่โลหิต') ?>
                                                </div>
                                            </div>
