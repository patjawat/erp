...
<div class="row">
    ...
    <div class="col-lg-6">
        <?=$form->field($model, 'data_json[surname_old]')->textInput(['maxlength' => true])->label('นามสกุลเดิม')?>
    ...
    <div class="col-lg-6">
        <?=$form->field($model, 'data_json[better_half]')->textInput(['maxlength' => true])->label('คู่สมรส')?>
    ...
    <div class="col-lg-6">
        ...
        <?=$form->field($model, 'data_json[child]')->textInput(['maxlength' => true])->label('จำนวนบุตร')?>
</div>
