                ...
                <div class="card profile-box flex-fill">
                    <div class="card-body">
                        ...
                        <ul class="personal-info">
                            <li>
                                <div class="title">เลขประจำตัวประชาชน</div>
                                <div class="text">1234567891124</div>
                            </li>
                            <li>
                ...
                <div class="card profile-box flex-fill">
                    <div class="card-body">
                        <h3 class="card-title">ครอบครัว
                            <?=Html::a('<i class="fas fa-pencil-alt"></i>',['/profile/form-family'],['class' => 'edit-icon open-modal']);?>
                        ...
                        <ul class="personal-info">
                            <li>
                                <div class="title">บิดา </div>
                                <div class="text">นายสดใส ใจสดชื่น</div>
                            </li>
                            <li>
                                <div class="title">มารดา</div>
                                <div class="text">นางพอใจ ใจสดชื่น</div>
                            </li>
                            <li>
                                <div class="title">นามสกุลเดิม </div>
                                <div class="text">ชมกลิ่น</div>
                            </li>
                            <li>
                                <div class="title">คู่สมรส</div>
                                <div class="text">-</div>
                            </li>
                            <li>
                                <div class="title">นามสกุลเดิม</div>
