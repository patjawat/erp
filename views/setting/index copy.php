        ...
        <ul class="nav col-12 col-lg-auto  justify-content-center  text-small menu-box">
            <li>
                <?=Html::a(
                        ...
                        ['/backoffice/default/data'],['class' => 'nav-link text-secondary d-flex flex-column text-center justify-content-center text-truncate open-modal','data' => ['size' => 'modal-md'],'style' => ''])?>
            </li>
