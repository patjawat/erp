...
?>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="inbox.html">งานพัสดุ</a></li>
							...
							<li class="submenu">
								...
								<ul style="display:none;">
								<li><a href="/employees">ทะเบียนบุคลากร</a></li>
									<li><a href="holidays.html">ปฎิทินวันหยุด</a></li>
							...
							<li class="menu-title"> 
								...
								<li> 
									<a href="settings.html"><i class="la la-cog"></i> <span>ตั้งค่าระบบ</span></a>
								</li>
