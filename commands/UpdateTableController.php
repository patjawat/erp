...
class UpdateTableController extends Controller
{
    ...
    public static function RouteList()
    {
        return [
            ...
            ['name' => '/am/maintenance/*', 'type' => 2, 'description' => ''],
            ['name' => '/am/calibration/*', 'type' => 2, 'description' => ''],
            ...
            ['name' => '/helpdesk/expenses/*', 'type' => 2, 'description' => ''],
    ...
    public static function ChildList()
    {
        return [
            ...
            ['child' => '/helpdesk/service/*', 'parent' => 'computer'],
            ['child' => '/helpdesk/service-record/*', 'parent' => 'computer'],
            ['child' => '/helpdesk/repair-parts/*', 'parent' => 'computer'],
            ['child' => '/helpdesk/repair-parts/*', 'parent' => 'computer'],
            ['child' => '/helpdesk/expenses/*', 'parent' => 'computer'],
            ['child' => '/am/maintenance/*', 'parent' => 'computer'],
            ['child' => '/am/calibration/*', 'parent' => 'computer'],
            ['child' => '/am/asset-document/*', 'parent' => 'computer'],

            ['child' => '/helpdesk/default/repair-select', 'parent' => 'user'],
            ['child' => '/helpdesk/team/*', 'parent' => 'technician'],
            ['child' => '/helpdesk/service/*', 'parent' => 'technician'],
            ...
            ['child' => '/helpdesk/expenses/*', 'parent' => 'technician'],
            ...
            ['child' => '/helpdesk/service/*', 'parent' => 'medical'],
            ['child' => '/helpdesk/service-record/*', 'parent' => 'medical'],
            ['child' => '/helpdesk/repair-parts/*', 'parent' => 'medical'],
            ['child' => '/helpdesk/expenses/*', 'parent' => 'medical'],
            ['child' => '/am/maintenance/*', 'parent' => 'medical'],
            ['child' => '/am/calibration/*', 'parent' => 'medical'],
            ['child' => '/am/asset-document/*', 'parent' => 'medical'],
