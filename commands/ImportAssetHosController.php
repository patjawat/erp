 ...
 * @since 2.0
 */
class ImportAssetHosController extends Controller
{
    /**
    ...
    public static function Util()
    {
        ...
        a.PRICE_PER_UNIT as price,
                ...
                a.SERIAL_NO as serial_number
                        ...
                        LEFT JOIN sup_buy s_buy ON s_buy.BUY_ID = a.BUY_ID
                        LEFT JOIN sup_type st ON st.SUP_TYPE_ID = a.TYPE_ID
                        LEFT JOIN sup_type_master stm ON stm.SUP_TYPE_MASTER_ID = st.SUP_TYPE_MASTER_ID
                        LEFT JOIN sup_decline sd ON sd.DECLINE_ID = a.DECLINE_ID
                        LEFT JOIN ar_status  ON ar_status.STATUS_ID = a.STATUS_ID 
        ...
        foreach ($typeQuerys as $type) {
            ...
            $assetType->category_id = isset($getGroup->code) ? $getGroup->code : 0;
        ...
        $unitQuerys = Yii::$app->db2->createCommand("SELECT * FROM sup_unit")->queryAll();
