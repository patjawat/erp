...
class m240916_104256_create_leave_table extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable('{{%leave}}', [
            ...
            'total_days' => $this->double()->comment('จำนวนวัน'),
        ...
        if (count($sql) < 1) {
            ...
            */
            $this->insert('categorise', ['code' => 'Pending', 'name' => 'leave_status', 'title' => 'รอ หน.เห็นชอบ']);
            $this->insert('categorise', ['code' => 'Checking1_pass', 'name' => 'leave_status', 'title' => 'หน.เห็นชอบ']);
            $this->insert('categorise', ['code' => 'Checking1_reject', 'name' => 'leave_status', 'title' => 'หน.ไม่เห็นชอบ']);
            $this->insert('categorise', ['code' => 'Checking2_pass', 'name' => 'leave_status', 'title' => 'หน.กลุ่มงานเห็นชอบ']);
            $this->insert('categorise', ['code' => 'Checking2_reject', 'name' => 'leave_status', 'title' => 'หน.กลุ่มงานไม่เห็นชอบ']);
            $this->insert('categorise', ['code' => 'Checkup_pass', 'name' => 'leave_status', 'title' => 'ตรวจสอบผ่าน']);
            $this->insert('categorise', ['code' => 'Checkup_reject', 'name' => 'leave_status', 'title' => 'ตรวจสอบไม่ผ่าน']);
            $this->insert('categorise', ['code' => 'Approve', 'name' => 'leave_status', 'title' => 'ผอ.อนุมัติ']);
            $this->insert('categorise', ['code' => 'ReqCancel', 'name' => 'leave_status', 'title' => 'ขอยกเลิก']);
            $this->insert('categorise', ['code' => 'Cancel', 'name' => 'leave_status', 'title' => 'ยกเลิก']);
            $this->insert('categorise', ['code' => 'Reject', 'name' => 'leave_status', 'title' => 'ไม่อนุมัติ']);
        }
