...
class m240701_090624_create_stock_table extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable('stock', [
            ...
            'movement_type' => "ENUM('receive', 'request', 'transfer') NOT NULL COMMENT 'ประเภทการเคลื่อนไหว (receive = รับเข้า, issue = เบิก, TRANSFER = โอนย้าย)'",
            'receive_type' => "ENUM('normal', 'purchase') COMMENT 'วิธีนำเข้า (normal = รับเข้าแบบปกติ, purchase = รับเข้าจาก PO)'",
