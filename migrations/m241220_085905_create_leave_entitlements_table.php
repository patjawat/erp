...
class m241220_085905_create_leave_entitlements_table extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable('{{%leave_entitlements}}', [
            ...
            'year_of_service' => $this->integer()->notNull()->defaultValue(0)->comment('อายุงาน(ปี)'),
            'balance' => $this->double()->notNull()->defaultValue(0)->comment('วันที่ลาพักผ่อนสะสม'),
            'leave_on_year' => $this->integer()->notNull()->defaultValue(0)->comment('วันที่ลาพักผ่อนประจำปี'),
